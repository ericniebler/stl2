...
\begin{codeblock}
  ...
  template <@\changed{class}{_Auto}@ C> auto crbegin(const C& c) -> decltype(@\changed{std}{ranges_v1}@::rbegin(c));
  template <@\changed{class}{_Auto}@ C> auto crend(const C& c) -> decltype(@\changed{std}{ranges_v1}@::rend(c));
\end{codeblock}
\begin{addedblock}
\begin{codeblock}
...
satisfies the WeaklyIncrementable
concept~(\ref{iterators.weaklyincrementable}), \tcode{Readable} is the name of a type that
satisfies the Readable concept~(\ref{iterators.readable}), and
\tcode{WeakInputIterator} is the name of a type that satisfies the
...
\begin{addedblock}
\begin{codeblock}
@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<WeaklyIncrementable>
@\oldtxt{ValueType}\newtxt{value_type_t}@<Readable>
@\oldtxt{ValueType}\newtxt{value_type_t}@<WeakInputIterator>
\end{codeblock}
\end{addedblock}
...
\item If \tcode{C} is the same as or inherits from \tcode{std::input_iterator_tag} or
      ...
      is \tcode{C}.
\item If \tcode{experimental::ranges\oldtxt{_v1}::\oldtxt{ReferenceType}\newtxt{reference_t}<In>} is not a reference type,
      \tcode{std::\brk{}iterator_traits<In>::\brk{}iterator_category} is \tcode{std::input_iterator_tag}.
\item If \tcode{C} is the same as or inherits from \tcode{experimental::\brk{}ranges\oldtxt{_v1}::\brk{}random_access_iterator_tag},
      \tcode{std::\brk{}iterator_traits<In>::\brk{}iterator_category} is \tcode{std::random_access_iterator_tag}.
\item If \tcode{C} is the same as or inherits from \tcode{experimental::\brk{}ranges\oldtxt{_v1}::\brk{}bidirectional_iterator_tag},
      \tcode{std::\brk{}iterator_traits<In>::\brk{}iterator_category} is \tcode{std::bidirectional_iterator_tag}.
\item If \tcode{C} is the same as or inherits from \tcode{experimental::\brk{}ranges\oldtxt{_v1}::\brk{}forward_iterator_tag},
...
\oldtxt{It\-er\-a\-tor\-Ca\-te\-go\-ry}\newtxt{it\-er\-a\-tor_\-ca\-te\-go\-ry_t}\added{<Iterator>}}
...
evolve(BidirectionalIterator first, BidirectionalIterator last) {
  evolve(first, last,
    ...
    @\oldtxt{IteratorCategory}\newtxt{iterator_category_t}\added{<BidirectionalIterator>\{\}}@);
}
...
\pnum
If \tcode{SizedIteratorRange<I, S>()} is satisfied, this function shall
dispatch to \tcode{advance(i, bound - i)}.
\end{itemdescr}
...
\pnum
If \tcode{SizedIteratorRange<I, S>()} is satisfied:
...
\item If both \tcode{T} and \tcode{const T} satisfy \tcode{Range} and \tcode{\oldtxt{ReferenceType}reference_t}
