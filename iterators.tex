...
is reachable from
\tcode{i},
they \removed{refer to elements of the same sequence}\newnewtxt{denote a range}.
...
A range \removed{\range{i}{i}}\newnewtxt{\range{i}{s}}
is an empty range\newnewtxt{ if \tcode{i == s}};
\removed{in general, a range \range{i}{j}}\newnewtxt{otherwise, \range{i}{s}}
...
operator\removed{s}, the library provides \removed{two}\newnewtxt{four} function templates
\tcode{advance}\newnewtxt{,}
\oldtxt{and}
...
\end{codeblock}\end{addedblock}\begin{codeblock}
    ...
    reverse_iterator(const reverse_iterator<@\removed{U}\newnewtxt{ConvertibleTo<I>}@>& @\removed{u}\newnewtxt{i}@);
    @\removed{template <class U>}@
      @\oldtxt{requires ConvertibleTo<U, I>()}@
    reverse_iterator& operator=(const reverse_iterator<@\removed{U}\newnewtxt{ConvertibleTo<I>}@>& @\removed{u}\newnewtxt{i}@);
...
@\removed{template <class U>}@
  @\oldtxt{requires ConvertibleTo<U, I>()}@
reverse_iterator&
  operator=(const reverse_iterator<@\removed{U}\newnewtxt{ConvertibleTo<I>}@>& @\removed{u}\newnewtxt{i}@);
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects
Assigns \tcode{\removed{u.base()}\newnewtxt{i.current}} to \tcode{current}.
...
Insert iterators satisfy \removed{the requirements of output iterators}\newnewtxt{\tcode{OutputIterator}}.
\tcode{operator*}
...
\end{codeblock}\end{addedblock}\begin{codeblock}
    ...
    @\removed{template <class U>}@
      @\oldtxt{requires ConvertibleTo<U, I>()}@
    move_iterator(const move_iterator<@\removed{U}\newnewtxt{ConvertibleTo<I>}@>& @\removed{u}\newnewtxt{i}@);
    @\removed{template <class U>}@
      @\oldtxt{requires ConvertibleTo<U, I>()}@
    move_iterator& operator=(const move_iterator<@\removed{U}\newnewtxt{ConvertibleTo<I>}@>& @\removed{u}\newnewtxt{i}@);

    @\removed{iterator_type}\newnewtxt{I}@ base() const;
    reference operator*() const;
...
\pnum
\effects Constructs a \tcode{move_iterator}, initializing
\tcode{current} with \removed{\tcode{u.base()}}\newnewtxt{\tcode{i.current}}.
...
\begin{itemdescr}
\pnum
\effects Assigns \removed{\tcode{u.base()}}\newnewtxt{\tcode{i.current}} to
\tcode{current}.
...
\removed{\returns}
\newnewtxt{\effects Equivalent to }
\tcode{x.\removed{base()}\newnewtxt{current} == y.\removed{base()}\newnewtxt{current}}.
\end{itemdescr}
...
\pnum
\effects
Constructs the end-of-stream iterator. If \tcode{T} is a literal type, then \removed{this}\newnewtxt{these}
constructor\newnewtxt{s} shall be\removed{ a} \tcode{constexpr} constructor\newnewtxt{s}.

\pnum
\postcondition \tcode{in_stream == \removed{0}\newnewtxt{nullptr}}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\requires \tcode{in_stream != \removed{0}\newnewtxt{nullptr}}.
...
\tcode{istreambuf_iterator()}
and the constructor
\tcode{istreambuf_iterator(\removed{0}\newnewtxt{nullptr})}
