...
\added{\ref{iterables}} & \oldtxt{Iterables}\newtxt{Ranges} &                 \\
\end{libsumtab}
...
(\newtxt{for example, }containers\added{ and ranges}) in a uniform manner.
...
\begin{codeblock}
  template <class@\oldtxt{, class = void}@> struct value_type { };
  template <class T>
  struct value_type<T*>
    : enable_if<@\oldtxt{!is_void}\newtxt{is_object}@<T>::value, remove_cv_t<T>> { };
  @{\oldtxt{template <class T>}@
  @{\oldtxt{struct value_type<T[]> : remove_cv<T> \{ \};}@
  @{\oldtxt{template <class T, size_t N>}@
  @{\oldtxt{struct value_type<T[N]> : remove_cv<T> \{ \};}@
  @{\newtxt{template <class I>}@
  @{\newtxt{struct value_type<I const> : value_type<decay_t<I>{}> \{ \};}@
  @{\newtxt{template <class I>}@
  @{\newtxt{struct value_type<I volatile> : value_type<decay_t<I>{}> \{ \};}@
  @{\newtxt{template <class I>}@
  @{\newtxt{struct value_type<I const volatile> : value_type<decay_t<I>{}> \{ \};}@
  template <class T>
    @\newtxt{requires requires \{ typename T::value_type; \}}@
  struct value_type<T@\oldtxt{, void_t<typename T::value_type>}@>
    : enable_if<@\oldtxt{!is_void}\newtxt{is_object}@<typename T::value_type>::value, typename T::value_type> { };
  template <class T>
    @\newtxt{requires requires \{ typename T::element_type; \}}@
  struct value_type<T@\oldtxt{, void_t<typename T::element_type>}@>
    : enable_if<@\oldtxt{!is_void}\newtxt{is_object}@<typename T::element_type>::value, typename T::element_type> { };
...
be a\oldtxt{n}\newtxt{ dereferenceable} object of type \tcode{Out}. Then types \tcode{T} and
\tcode{Out} model \tcode{MoveWritable} if and only if

\begin{itemize}
\item If \oldtxt{\tcode{o}}\newtxt{\tcode{Out}} is \oldtxt{dereferenceable}\newtxt{\tcode{Readable}},
then after the assignment \tcode{*o = move(v)}, \oldtxt{the value referred to by }\tcode{*o} is equal
...
of type \tcode{const T}, and let \tcode{o} be a\oldtxt{n}\newtxt{ dereferenceable} object of type
\tcode{Out}. Then types \tcode{T} and \tcode{Out} model \tcode{Writable} if and only if

\begin{itemize}
\item \oldtxt{A}\newtxt{If \tcode{Out} is \tcode{Readable}, a}fter the assignment \tcode{*o = v},
\oldtxt{the value referred to by} \tcode{*o} is equal to the value of \tcode{v} and \tcode{v} is
unchanged.
\end{itemize}
...
\pnum
Let \tcode{i} be an object of type \tcode{I}, and let \tcode{o} be a\oldtxt{n}
\newtxt{dereferenceable} object of type \tcode{Out}. Then types \tcode{I} and \tcode{Out} model
\tcode{IndirectlyMovable} if and only if

\begin{itemize}
\item \oldtxt{A}\newtxt{If \tcode{Out} is \tcode{Readable}, a}fter the assignment
\tcode{*o = move(*i)}, \oldtxt{the value referred to by} \tcode{*o} is equal to
...
\begin{itemize}
\item \oldtxt{A}\newtxt{If \tcode{Out} is \tcode{Readable}, a}fter the assignment \tcode{*o = *i},
\oldtxt{the value referred to by} \tcode{*o} is equal to the value of \tcode{*i} and the value of
\tcode{*i} is unchanged.
\end{itemize}
...
\begin{codeblock}
  ...
  concept bool IndirectlySwappable =
    ...
    @\oldtxt{Swappable<ReferenceType<I1>> \&\&}@
    @\oldtxt{Swappable<ReferenceType<I2>>;}@
\end{codeblock}
...
\pnum
\enternote For \tcode{WeaklyIncrementable} types, \tcode{a} equals \tcode{b} does \newtxt{not }imply that \tcode{++a}
...
\ednote{``bound to the same object'' is wrong!}
...
\begin{codeblock}
  ...
  concept bool BidirectionalIterator =
    ...
    requires (I i) {
      @\oldtxt{\{ \dcr{}i \};}@
      @\oldtxt{requires Same<I\&, decltype(\dcr{}i)>;}@
      @\newtxt{\{ \dcr{}i \} -> Same<I\&>;}@
      @\oldtxt{\{ i\dcr{} \};}@
      @\oldtxt{requires Same<I, decltype(i\dcr{})>;}@
      @\newtxt{\{ i\dcr{} \} -> Same<I>;}@
    };
\end{codeblock}
\end{addedblock}
...
\begin{codeblock}
  @\newtxt{template <class I>}@
  @\newtxt{concept bool \xname{MutableIterator} = // \expos}@
    @\newtxt{Iterator<I> \&\&}@
    @\newtxt{requires(I i) \{}@
        @\newtxt{\{ *i \} -> auto\&;}@
        @\newtxt{*i = *i;}@
  ...
  concept bool RandomAccessIterator =
    ...
    requires (I i, I j, DifferenceType<I> n) {
      ...
      @\oldtxt{\{ i -= n \};}@
      @\oldtxt{\{ i - n \};}@
      @\oldtxt{requires Same<decltype(i += n), I\&>;}@
      @\oldtxt{requires Same<decltype(i + n), I>;}@
      @\oldtxt{requires Same<decltype(n + i), I>;}@
      @\oldtxt{requires Same<decltype(i -= n), I\&>;}@
      @\oldtxt{requires Same<decltype(i - n), I>;}@
      @\newtxt{\{ i += n \} -> Same<I\&>;}@
      @\newtxt{\{ i + n \} -> Same<I>;}@
...
from \tcode{a}. Let \tcode{n} be \oldtxt{an object}\newtxt{the smallest value} of type \tcode{DifferenceType<I>} such that after
\tcode{n} applications of \tcode{++a}, \tcode{(a == b) != false}. Then \tcode{I} models
\tcode{RandomAccessIterator} if and only if:

\begin{itemize}
\item \tcode{(a += n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ b}.
\item \tcode{\&(a += n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ \&a}.
\item \tcode{(a + n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ (a += n)}.
\item For any two positive integers \tcode{x} and \tcode{y}, if \tcode{a + (x + y)} is valid, then
\tcode{a + (x + y) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ (a + x) + y}.
\item \tcode{a + 0 }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ a}.
\item If \tcode{(a + (n - 1))} is valid, then \tcode{a + n }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ ++(a + (n - 1))}.
\item \tcode{(b += -n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ a}.
\item \tcode{(b -= n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ a}.
\item \tcode{\&(b -= n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ \&b}.
\item \tcode{(b - n) }\oldtxt{\tcode{==}}\newtxt{is equal to}\tcode{ (b -= n)}.
...
\begin{codeblock}
  ...
  struct Projected {
    @\oldtxt{using difference_type = DifferenceType<I>;}@
  ...
  @\newtxt{template <WeaklyIncrementable I, class Proj>}@
  @\newtxt{struct difference_type<Projected<I, Proj>{}> \{}@
    @\newtxt{using type = DifferenceType<I>;}@
  @\newtxt{\};}@
\end{codeblock}
...
\begin{codeblock}
  ...
  @\newtxt{template <class F, class I1, class I2 = I1>}@
  @\newtxt{concept bool IndirectCallableStrictWeakOrder =}@
    @\newtxt{Readable<I1> \&\&}@
    @\newtxt{Readable<I2> \&\&}@
    @\newtxt{StrictWeakOrder<FunctionType<F>, ValueType<I1>, ValueType<I2> >();}@
\end{codeblock}
...
\begin{codeblock}
  ...
  concept bool Mergeable =
    ...
    @\oldtxt{IndirectlyComparable<I1, I2, R, P1, P2>;}@
    @\newtxt{IndirectCallableStrictWeakOrder<R, Projected<I1, P1>, Projected<I2, P2> >;}@
\end{codeblock}

\pnum
\oldtxt{The relation \tcode{R} must represent a strict weak ordering.}
...
\begin{codeblock}
  ...
  concept bool Sortable =
    ForwardIterator<I> &&
    Permutable<I> &&
    IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<R, Projected<I, P>>;
\end{codeblock}
...
\tcode{S}. Let \tcode{n} be \oldtxt{an object}\newtxt{the smalled value} of type \tcode{DifferenceType<I>} such that after
...
\begin{addedblock}
\begin{codeblock}
  template <class@\oldtxt{, class = void}@> struct difference_type;
  template <class@\oldtxt{, class = void}@> struct value_type;
  template <class@\oldtxt{, class = void}@> struct iterator_category;
...
\begin{codeblock}
  ...
  concept bool @\xname{WeaklyEqualityComparable}@;  // \expos
  template<class I, class S>
  concept bool @\xname{WeakSentinel}@;              // \expos
  ...
  @\newtxt{// \ref{default.sentinels} Default sentinels}@
  @\newtxt{class default_sentinel;}@
  @\newtxt{constexpr bool operator==(default_sentinel x, default_sentinel y) noexcept;}@
  @\newtxt{constexpr bool operator!=(default_sentinel x, default_sentinel y) noexcept;}@
  @\newtxt{constexpr bool operator<(default_sentinel x, default_sentinel y) noexcept;}@
  @\newtxt{constexpr bool operator<=(default_sentinel x, default_sentinel y) noexcept;}@
  @\newtxt{constexpr bool operator>(default_sentinel x, default_sentinel y) noexcept;}@
  @\newtxt{constexpr bool operator>=(default_sentinel x, default_sentinel y) noexcept;}@
  @\newtxt{constexpr ptrdiff_t operator-(default_sentinel x, default_sentinel y) noexcept;}@

  // \ref{counted.iterators} Counted iterators\oldtxt{ and sentinels}
  template <Weak@\oldtxt{Input}@Iterator I> class counted_iterator;
  @\oldtxt{class counted_sentinel;}@

  template <Weak@\oldtxt{Input}@Iterator I1, Weak@\oldtxt{Input}@Iterator I2>
    bool operator==(
      const counted_iterator<I1>& x, const counted_iterator<I2>& y);
  template <Weak@\oldtxt{Input}@Iterator I>
    bool operator==(
      const counted_iterator<I>& x, @\oldtxt{counted}\newtxt{default}@_sentinel y);
  template <Weak@\oldtxt{Input}@Iterator I>
    bool operator==(
      @\oldtxt{counted}\newtxt{default}@_sentinel x, const counted_iterator<I>& y);
  @\oldtxt{bool operator==(counted_sentinel x, counted_sentinel y);}@
  template <Weak@\oldtxt{Input}@Iterator I1, Weak@\oldtxt{Input}@Iterator I2>
    bool operator!=(
      const counted_iterator<I1>& x, const counted_iterator<I2>& y);
  template <Weak@\oldtxt{Input}@Iterator I>
  ...
  template <Weak@\oldtxt{Input}@Iterator I>
    DifferenceType<I> operator-(
      @\oldtxt{counted}\newtxt{default}@_sentinel x, const counted_iterator<I>& y);
  @\oldtxt{ptrdiff_t operator-(counted_sentinel x, counted_sentinel y);}@
  template <RandomAccessIterator I>
    counted_iterator<I>
  ...
  template<Weak@\oldtxt{Input}@Iterator I>
    struct common_type<counted_iterator<I>, @\oldtxt{counted}\newtxt{default}@_sentinel>;
  template<Weak@\oldtxt{Input}@Iterator I>
    struct common_type<@\oldtxt{counted}\newtxt{default}@_sentinel, counted_iterator<I>>;
...
\begin{codeblock}
  template <class@\oldtxt{, class = void}@> struct difference_type { };
  template <class T>
  struct difference_type<T*> @\newtxt{: enable_if<is_object<I>::value, ptrdiff_t>}@ {@\newtxt{ \};}@
  ...
  @\oldtxt{template <class T> struct difference_type<T[]> \{}@
    @\oldtxt{using type = ptrdiff_t;}@
  @\oldtxt{\};}@
  @\oldtxt{template <class T, size_t N> struct difference_type<T[N]> \{}@
    @\oldtxt{using type = ptrdiff_t;}@
  @\oldtxt{\};}@
  @\newtxt{template <class I>}@
  @\newtxt{struct difference_type<I const> : difference_type<decay_t<I>{}> \{ \};}@
  @\newtxt{template <class I>}@
  @\newtxt{struct difference_type<I volatile> : difference_type<decay_t<I>{}> \{ \};}@
  @\newtxt{template <class I>}@
  @\newtxt{struct difference_type<I const volatile> : difference_type<decay_t<I>{}> \{ \};}@
  template <class T>
    @\newtxt{requires requires \{ typename T::difference_type; \}}@
  struct difference_type<T@\oldtxt{, void_t<typename T::difference_type>}@> {
    using type = typename T::difference_type;
  };
  template <class T>
    @\newtxt{requires is_integral<T>()}@
  struct difference_type<T@\oldtxt{, enable_if_t<is_integral<T>::value>}@>
...
\begin{codeblock}
  ...
  struct iterator_category<T*>
    @\newtxt{: enable_if<is_object<T>::value, random_access_iterator_tag> }@{@\newtxt{ \};}@
    @\oldtxt{using type = random_access_iterator_tag;}@
  @\oldtxt{\};}@
  @\newtxt{template <class T>}@
  @\newtxt{struct iterator_category<T const> : iterator_category<T> \{ \};}@
  @\newtxt{template <class T>}@
  @\newtxt{struct iterator_category<T volatile> : iterator_category<T> \{ \};}@
  @\newtxt{template <class T>}@
  @\newtxt{struct iterator_category<T const volatile> : iterator_category<T> \{ \};}@
  template <class T>
    @\newtxt{requires requires \{ typename T::iterator_category; \}}@
  struct iterator_category<T@\oldtxt{, void_t<typename T::iterator_category>}@> {
...
\begin{codeblock}
  template <WeakInputIterator I@\oldtxt{, class = void}@> struct @\xname{pointer_type}@ {
    using type = add_pointer_t<ReferenceType<I>>;
  };
  template <WeakInputIterator I>
    @\newtxt{requires requires(I i) \{ \{ i.operator->() \} -> auto\&\&; \}}@
  struct @\xname{pointer_type}@<I@\oldtxt{, void_t<decltype(declval<I>().operator->())>}@> {
...
\end{codeblock}\end{addedblock}\begin{codeblock}
    ...
    @\newtxt{pointer operator->() const;} \ednote{Added back since N4382}@
...
\begin{itemdescr}
\pnum
\returns \removed{\tcode{std::addressof(operator*())}}\newtxt{\tcode{current}}.

\ednote{Added back since N4382.}
\end{itemdescr}
}
...
\end{codeblock}\end{addedblock}\begin{codeblock}
    ...
    move_iterator operator--(int)@\removed{;}@
      @\newtxt{requires BidirectionalIterator<I>;}@
...
used together with class \tcode{\oldtxt{counted}\newtxt{default}_sentinel} in calls to generic
...
vector<string> v(make_counted_iterator(s.begin(), 10),
                 @\oldtxt{counted}\newtxt{default}@_sentinel()); // copies 10 strings into \tcode{v}
\end{codeblock}
...
namespace std {
  ...
  public:
    ...
    @\oldtxt{using iterator_category =}@
      @\oldtxt{conditional_t<ForwardIterator<I>,}@
                    @\oldtxt{IteratorCategory<I>,}@
                    @\oldtxt{std::input_iterator_tag>;}@
    using reference = ReferenceType<I>;

    counted_iterator();
    counted_iterator(I x, DifferenceType<I> n);
    template <Weak@\oldtxt{Input}@Iterator U>
  ...
  @\newtxt{template <WeakInputIterator I>}@
  @\newtxt{struct value_type<counted_iterator<I>{}> : value_type<I> \{ \};}@

  @\newtxt{template <WeakInputIterator I>}@
  @\newtxt{struct iterator_category<counted_iterator<I>{}> \{}@
    @\newtxt{using type = input_iterator_tag;}@
  @\newtxt{\};}@
  @\newtxt{template <ForwardIterator I>}@
  @\newtxt{struct iterator_category<counted_iterator<I>{}> : iterator_category<I> \{ \};}@
...
namespace std {
  template<Weak@\oldtxt{Input}@Iterator I>
  struct common_type<counted_iterator<I>, @\oldtxt{counted}\newtxt{default}@_sentinel> {
    using type = common_iterator<counted_iterator<I>, @\oldtxt{counted}\newtxt{default}@_sentinel>;
  };
  template<Weak@\oldtxt{Input}@Iterator I>
  struct common_type<@\oldtxt{counted}\newtxt{default}@_sentinel, counted_iterator<I>> {
    using type = common_iterator<counted_iterator<I>, @\oldtxt{counted}\newtxt{default}@_sentinel>;
...
and \tcode{\oldtxt{counted}\newtxt{default}_sentinel} can satisfy the \tcode{Common} requirement of the
...
For any other iterator value a
\tcode{const T*}
is returned.}~(\ednote{Added back since N4382.})
...
namespace std {
  ...
  public:
   ...
   ~istream_iterator() = default;
    ...
    @\newtxt{const T* operator->() const;} \ednote{Added back since N4382.}@
...
\pnum
\returns
\tcode{\removed{\&(operator*())}std::addressof(operator*())}.
...
\newtxt{\enternote \tcode{operator->} may return a proxy. \exitnote}~(\ednote{Added back
since N4382.})
Each time
\tcode{operator++}
...
\pnum
The following subclauses describe
\oldtxt{iterable}\newtxt{range} and \oldtxt{range}\newtxt{view} requirements, and
components for
\oldtxt{iterable}\newtxt{range} primitives,
predefined ranges,
and stream ranges,
...
\begin{libsumtab}{Ranges library summary}{tab:iterables.lib.summary}
  ...
  \ref{iterable.primitives} & \oldtxt{Iterable}\newtxt{Range} primitives   &   \tcode{<iterator>}      \\
...
\pnum
\oldtxt{Iterables}\newtxt{Ranges} are an abstraction of containers that allow a C++ program to
operate on elements of data structures uniformly. It their simplest form, a\oldtxt{n}
\oldtxt{iterable}\newtxt{range} object is one on which one can call \tcode{begin} and
...
also the semantics and complexity assumptions of \oldtxt{iterables}\newtxt{ranges}.

\pnum
This International Standard defines three fundamental categories of \oldtxt{iterables}\newtxt{ranges}
based on the syntax and semantics supported by each: \oldtxt{\textit{iterable}}\newtxt{\techterm{range}},
\oldtxt{\textit{sized iterable}}\newtxt{\techterm{sized range}} and \oldtxt{\textit{range}}\newtxt{\techterm{view}}, as shown in
Table~\ref{tab:iterables.relations}.

\begin{floattable}{Relations among \oldtxt{iterable}\newtxt{range} categories}{tab:iterables.relations}
  {lll}
  \topline
  \textbf{Sized \oldtxt{Iterable}\newtxt{Range}} &            &                                          \\
                                                 & $\searrow$ &                                          \\
                                                 &            & \textbf{\oldtxt{Iterable}\newtxt{Range}} \\
                                                 & $\nearrow$ &                                          \\
  \textbf{\oldtxt{Range}\newtxt{View}}           &            &                                          \\
\end{floattable}

\pnum
The \oldtxt{\tcode{Iterable}}\newtxt{\tcode{Range}} concept requires only that \tcode{begin} and \tcode{end}
return an iterator and a sentinel. \enternote An iterator is a valid sentinel.
\exitnote The \oldtxt{\tcode{SizedIterable}}\newtxt{\tcode{SizedRange}}  concept refines \oldtxt{\tcode{Iterable}}\newtxt{\tcode{Range}} but adds
the requirement that the number of elements in the \oldtxt{iterable}\newtxt{range} can be determined
in constant time with the \tcode{size} function. The \oldtxt{\tcode{Range}}\newtxt{\tcode{View}} concept describes
requirements on an \oldtxt{\tcode{Iterable}}\newtxt{\tcode{Range}} type with constant-time copy and assign
operations.

\pnum
In addition to the three fundamental \oldtxt{iterable}\newtxt{range} categories, this standard defines
a number of convenience refinements of \oldtxt{\tcode{Iterable}}\newtxt{\tcode{Range}} that group together requirements
that appear often in the concepts, algorithms, and range \oldtxt{views}\newtxt{adaptors}.
\oldtxt{\textit{Bounded iterables}}\newtxt{\techterm{Bounded ranges}}
are \oldtxt{iterables}\newtxt{ranges} for which \tcode{begin} and \tcode{end} return objects of the
same type. \oldtxt{\textit{Random access iterables}}\newtxt{\techterm{Random access ranges}} are \oldtxt{iterables}\newtxt{ranges} for which
\tcode{begin} returns a model of
\tcode{RandomAccessIterator}~(\ref{random.access.iterators}). The \oldtxt{iterable}\newtxt{range}
categories \oldtxt{\textit{bidirectional iterables}}\newtxt{\techterm{bidirectional ranges}},
\oldtxt{\textit{forward iterables}}\newtxt{\techterm{forward ranges}},
\oldtxt{\textit{input iterables}}\newtxt{\techterm{input ranges}} and
\oldtxt{\textit{output iterables}}\newtxt{\techterm{output ranges}} are defined similarly.
\enternote There is no \oldtxt{\textit{weak input iterables}}\newtxt{\techterm{weak input ranges}} or
\oldtxt{\textit{weak output iterables}}\newtxt{\techterm{weak output ranges}} because of the \tcode{EqualityComparable}
...
\pnum
The \oldtxt{\tcode{Iterable}}\newtxt{\tcode{Range}} concept defines the requirements of a type that allows
iteration over its elements by providing a \tcode{begin} iterator and an
\tcode{end} iterator or sentinel.

\begin{codeblock}
@\newtxt{template <class T>}@
@\newtxt{using IteratorType = decltype(begin(declval<T>()));}@

@\newtxt{template <class T>}@
@\newtxt{using SentinelType = decltype(end(declval<T>()));}@

template <class T>
concept bool @\oldtxt{Iterable}\newtxt{Range}@ =
  requires(T t) {
...
\pnum
The \oldtxt{\tcode{SizedIterable}}\newtxt{\tcode{SizedRange}} concept describes the requirements
of a\oldtxt{n} \oldtxt{\tcode{Iterable}}\newtxt{\tcode{Range}}
type that knows its size in constant time with the \tcode{size} function.

\begin{codeblock}
// \expos
template <class T>
concept bool @\xname{Sized\oldtxt{Iterable}\newtxt{Range}Like}@ =
  @\oldtxt{Iterable}\newtxt{Range}@<T> &&
  requires(T t) {
    { size(t) } -> Integral;
...
template <class T>
concept bool Sized@\oldtxt{Iterable}\newtxt{Range}@ =
  @\xname{Sized\oldtxt{Iterable}\newtxt{Range}Like}@<T> && is_sized_@\oldtxt{iterable}\newtxt{range}@<T>::value;
\end{codeblock}

\pnum
For any type \tcode{T}, \tcode{is_sized_\oldtxt{iterable}\newtxt{range}<T>} derives from
\tcode{true_type} if \tcode{T} models \tcode{\xname{Sized\oldtxt{Iterable}\newtxt{Range}Like}},
and \tcode{false_type} otherwise.

\pnum
Users are free to specialize \tcode{is_sized_\oldtxt{iterable}\newtxt{range}}. \enternote Users
may \newtxt{want to }specialize \tcode{is_sized_\oldtxt{iterable}\newtxt{range}} to override the default in the
case of accidental conformance.\exitnote

\pnum
\enternote A possible implementation for \tcode{is_sized_\oldtxt{iterable}\newtxt{range}} is given below:

\begin{codeblock}
template <class R>
struct is_sized_@\oldtxt{iterable}\newtxt{range}@ : false_type { };

template <@\xname{Sized\oldtxt{Iterable}\newtxt{Range}Like}@ R>
struct is_sized_@\oldtxt{iterable}\newtxt{range}@<R> : true_type { };
\end{codeblock}
\exitnote
...
\pnum
The \tcode{\oldtxt{Range}\newtxt{View}} concept describes the requirements of a\oldtxt{n} \tcode{\oldtxt{Iterable}\newtxt{Range}} type that
has constant time copy, move and assignment operators; that is, the cost of
these operations is not proportional to the number of elements in the \tcode{\oldtxt{Range}\newtxt{View}}.

\pnum
\enterexample
Examples of \tcode{\oldtxt{Range}\newtxt{View}}s are:

\begin{itemize}
\item A\oldtxt{n} \tcode{\oldtxt{Iterable}\newtxt{Range}} type that wraps a pair of iterators.

\item A\oldtxt{n} \tcode{\oldtxt{Iterable}\newtxt{Range}} type that hold its elements by \tcode{shared_ptr}
and shares ownership with all its copies.

\item A\oldtxt{n} \tcode{\oldtxt{Iterable}\newtxt{Range}} type that generates its elements on demand.
\end{itemize}

A container~(\cxxref{containers}) is not a \tcode{\oldtxt{Range}\newtxt{View}} since copying the
container copies the elements, which cannot be done in constant time.
\exitexample

\begin{codeblock}
template <class T>
concept bool @\oldtxt{Range}\newtxt{View}@ =
  @\oldtxt{Iterable}\newtxt{Range}@<T> && Semiregular<T> && is_@\oldtxt{range}\newtxt{view}@<T>::value;
\end{codeblock}

\pnum
Since the difference between \tcode{\oldtxt{Iterable}\newtxt{Range}} and
\tcode{\oldtxt{Range}\newtxt{View}} is largely semantic, the
two are differentiated with the help of the \tcode{is_\oldtxt{range}\newtxt{view}} trait. Users may
specialize the \tcode{is_\oldtxt{range}\newtxt{view}} trait. By default,
\tcode{is_\oldtxt{range}\newtxt{view}} uses the \newtxt{following }heuristics to determine whether an
\tcode{\oldtxt{Iterable}\newtxt{Range}} type \tcode{T} is a \tcode{\oldtxt{Range}\newtxt{View}}:

\begin{itemize}
\item If \tcode{T} derives from \tcode{\oldtxt{range}\newtxt{view}_base}, \tcode{is_\oldtxt{range}\newtxt{view}<T>::value}
is true.
\item If a top-level \tcode{const} changes \tcode{T}'s \tcode{IteratorType}'s
\tcode{ReferenceType} type, \tcode{is_\oldtxt{range}\newtxt{view}<T>::value}
...
\pnum
\enternote
Below is a possible implementation of the \tcode{is_\oldtxt{range}\newtxt{view}} trait.
...
// \expos
template <class T>
struct is_@\oldtxt{range}\newtxt{view}@ : false_type { };

template <@\oldtxt{Iterable}\newtxt{Range}@ T>
  requires Derived<remove_reference_t<T>, @\oldtxt{range}\newtxt{view}@_base> ||
    !@\xname{ContainerLike}@<remove_reference_t<T>>
struct is_@\oldtxt{range}\newtxt{view}@<T> : true_type { };
\end{codeblock}
\exitnote
...
\pnum
The \tcode{Bounded\oldtxt{Iterable}\newtxt{Range}} concept describes requirements of an \tcode{\oldtxt{Iterable}\newtxt{Range}} type
...
\tcode{Bounded\oldtxt{Iterable}\newtxt{Range}}. \exitnote

\begin{codeblock}
template <class T>
concept bool Bounded@\oldtxt{Iterable}\newtxt{Range}@ =
  @\oldtxt{Iterable}\newtxt{Range}@<T> && Same<IteratorType<T>, SentinelType<T>>;
\end{codeblock}

\rSec3[input.iterables]{Input ranges}

\pnum
The \tcode{Input\oldtxt{Iterable}\newtxt{Range}} concept describes requirements of an \tcode{\oldtxt{Iterable}\newtxt{Range}} type
for which \tcode{begin} returns a model of
\tcode{InputIterator}~(\ref{input.iterators}).

\begin{codeblock}
template <class T>
concept bool Input@\oldtxt{Iterable}\newtxt{Range}@ =
  @\oldtxt{Iterable}\newtxt{Range}@<T> && InputIterator<IteratorType<T>>;
\end{codeblock}

\rSec3[forward.iterables]{Forward ranges}

\pnum
The \tcode{Forward\oldtxt{Iterable}\newtxt{Range}} concept describes requirements of an
\tcode{Input\oldtxt{Iterable}\newtxt{Range}} type for which \tcode{begin} returns a model of
\tcode{ForwardIterator}~(\ref{forward.iterators}).

\begin{codeblock}
template <class T>
concept bool Forward@\oldtxt{Iterable}\newtxt{Range}@ =
  Input@\oldtxt{Iterable}\newtxt{Range}@<T> && ForwardIterator<IteratorType<T>>;
\end{codeblock}

\rSec3[bidirectional.iterables]{Bidirectional ranges}

\pnum
The \tcode{Bidirectional\oldtxt{Iterable}\newtxt{Range}} concept describes requirements of a
\tcode{Forward\oldtxt{Iterable}\newtxt{Range}} type for which \tcode{begin} returns a model of
\tcode{BidirectionalIterator}~(\ref{bidirectional.iterators}).

\begin{codeblock}
template <class T>
concept bool Bidirectional@\oldtxt{Iterable}\newtxt{Range}@ =
  Forward@\oldtxt{Iterable}\newtxt{Range}@<T> && BidirectionalIterator<IteratorType<T>>;
\end{codeblock}

\rSec3[random.access.iterables]{Random access ranges}

\pnum
The \tcode{RandomAccess\oldtxt{Iterable}\newtxt{Range}} concept describes requirements of a
\tcode{Bidirectional\oldtxt{Iterable}\newtxt{Range}} type for which \tcode{begin} returns a model of
\tcode{RandomAccessIterator}~(\ref{random.access.iterators}).

\begin{codeblock}
template <class T>
concept bool RandomAccess@\oldtxt{Iterable}\newtxt{Range}@ =
  Bidirectional@\oldtxt{Iterable}\newtxt{Range}@<T> && RandomAccessIterator<IteratorType<T>>;
\end{codeblock}
