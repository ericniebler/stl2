...
\begin{itemdescr}
\pnum
\effects \added{Equivalent to: \tcode{return *prev(current);}}
\begin{codeblock}
...
\changed{\tcode{std::addressof(operator*())}}{\tcode{return prev(current);}}
\end{itemdescr}
...
\removed{\returns}
\added{\effects Equivalent to:}
\tcode{\added{return} x.current == y.current\added{;}}\removed{.}
\end{itemdescr}
...
\removed{\returns}
\added{\effects Equivalent to: }
\tcode{return reverse_iterator<\changed{Iterator}{I}>(x.current - n);}
\end{itemdescr}
...
\removed{\returns}
\added{\effects Equivalent to:}
\removed{\tcode{std::move}}\added{\tcode{return static_cast<reference>}}\tcode{(*current);}
\end{itemdescr}
...
\removed{\returns}
\added{\effects Equivalent to:}
\removed{\tcode{std::move}}\added{\tcode{return static_cast<reference>}}\tcode{(current[n]);}
\end{itemdescr}
...
\removed{\returns}
\added{\effects Equivalent to:}
\tcode{return x.\changed{base()}{current} == y.\changed{base()}{current};}
\end{itemdescr}
...
\pnum
\effects Equivalent to:
\changed{\tcode{\&(operator*())}}{\tcode{return std::addressof(operator*())}}.
\end{itemdescr}
