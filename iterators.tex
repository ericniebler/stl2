...
be reachable from \tcode{bound} and \tcode{Assignable<I\&, S\&\&>()} shall
be satisfied}.
...
\item If \oldtxt{\tcode{I} and \tcode{S} are the same type, this function
      is constant time}\newtxt{the syntactic requirements of
      \tcode{Assignable<I\&, S\&\&>()} are met, this function is equivalent
      to \tcode{i = std::move(bound)}}.
