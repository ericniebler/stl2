...
\begin{addedblock}
\begin{codeblock}
  template <class WeaklyIncrementable> struct DifferenceType;
  template <class WeakIterator> struct IteratorCategory;
  template <class WeakInputIterator> struct ValueType;
