...
concept bool SizedRange =
  @\xname{SizedRangeLike}@<T> && is_sized_range<T>::value;
\end{codeblock}
...
template <class T>
concept bool View =
  Range<T> && Semiregular<T> && is_view<T>::value;
\end{codeblock}
...
concept bool BoundedRange =
  Range<T> && Same<IteratorType<T>, SentinelType<T>>;
\end{codeblock}
...
concept bool InputRange =
  Range<T> && InputIterator<IteratorType<T>>;
\end{codeblock}
...
concept bool ForwardRange =
  InputRange<T> && ForwardIterator<IteratorType<T>>;
\end{codeblock}
...
concept bool BidirectionalRange =
  ForwardRange<T> && BidirectionalIterator<IteratorType<T>>;
\end{codeblock}
...
concept bool RandomAccessRange =
  BidirectionalRange<T> && RandomAccessIterator<IteratorType<T>>;
\end{codeblock}
