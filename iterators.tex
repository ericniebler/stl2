...
\begin{codeblock}
  ...
  concept bool Permutable@\newtxt{() \{}\oldtxt{ =}@
    @\newtxt{return}@ ForwardIterator<I>@\newtxt{()}@ &&
      @\oldtxt{Semiregular}\newtxt{Movable}@<@\oldtxt{ValueType}\newtxt{value_type_t}@<I>>@\newtxt{()}@ &&
...
relation, the value type must \oldtxt{model}\newtxt{satisfy} \tcode{\added{Strict}TotallyOrdered}.\exitnote
  ...
  template <InputIterator I1, @\xname{WeakSentinel}@<I1> S1,
    ...
    requires SizedIteratorRange<I1, I1>@\newtxt{()}@ && SizedIteratorRange<I2, I2>@\newtxt{()}@ &&
      @\newtxt{requires (const I1 i1, const S1 s1, const I2 i2, const S2 s2) \{}@
        @\oldtxt{requires (I1 a, I2 b) \{ }@{@\oldtxt{a}\newtxt{i1}@-@\oldtxt{b}\newtxt{i2}@}->@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2>; {@\oldtxt{b}\newtxt{i2}@-@\oldtxt{a}\newtxt{i1}@}->@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2>;@\oldtxt{ \}}@
        @\oldtxt{requires (I1 i, S2 s) \{ }@{@\oldtxt{i}\newtxt{i1}@-s@\newtxt{2}@}->@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2>; {s@\newtxt{2}@-@\oldtxt{i}\newtxt{i1}@}->@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2>;@\oldtxt{ \}}@
        @\oldtxt{requires (I2 i, S1 s) \{ }@{@\oldtxt{i}\newtxt{i2}@-s@\newtxt{1}@}->@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2>; {s@\newtxt{1}@-@\oldtxt{i}\newtxt{i2}@}->@\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2>;@\oldtxt{ \}}@
      @\newtxt{\}}@
  @\oldtxt{DifferenceType}\newtxt{difference_type_t}@<I2> operator-(
    const common_iterator<I1, S1>& x, const common_iterator<I2, S2>& y);
...
\end{codeblock}}{\color{addclr}\begin{codeblock}
  ...
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@WeakIterator I>
    struct common_type<@\newtxt{experimental::ranges\oldtxt{_v1}::}@counted_iterator<I>,
                       @\newtxt{experimental::ranges\oldtxt{_v1}::}@default_sentinel>;
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@WeakIterator I>
    struct common_type<@\newtxt{experimental::ranges\oldtxt{_v1}::}@default_sentinel,
                       @\newtxt{experimental::ranges\oldtxt{_v1}::}@counted_iterator<I>>;

  // \ref{unreachable.traits.specializations} \tcode{common_type} specializations
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@Iterator I>
    struct common_type<I, @\newtxt{experimental::ranges\oldtxt{_v1}::}@unreachable>;
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@Iterator I>
    struct common_type<@\newtxt{experimental::ranges\oldtxt{_v1}::}@unreachable, I>;
@{\color{newclr}\}}@
\end{codeblock}
}
...
\begin{codeblock}
  ...
  struct iterator_category<T> {
    using type = @\oldtxt{typename T::iterator_category}\newtxt{\seebelow}@;
  };
  template <class T>
...
namespace std {
  ...
  struct common_type<@\newtxt{experimental::ranges\oldtxt{_v1}::}@counted_iterator<I>,
                     @\newtxt{experimental::ranges\oldtxt{_v1}::}@default_sentinel> {
    using type = @\newtxt{experimental::ranges\oldtxt{_v1}::}@common_iterator<
      @\newtxt{experimental::ranges\oldtxt{_v1}::}@counted_iterator<I>,
      @\newtxt{experimental::ranges\oldtxt{_v1}::}@default_sentinel>;
  };
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@WeakIterator I>
...
namespace std {
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@Iterator I>
  struct common_type<I, @\newtxt{experimental::ranges\oldtxt{_v1}::}@unreachable> {
    using type = @\newtxt{experimental::ranges\oldtxt{_v1}::}@common_iterator<I, @\newtxt{experimental::ranges\oldtxt{_v1}::}@unreachable>;
  };
  template<@\newtxt{experimental::ranges\oldtxt{_v1}::}@Iterator I>
  struct common_type<@\newtxt{experimental::ranges\oldtxt{_v1}::}@unreachable, I> {
    using type = @\newtxt{experimental::ranges\oldtxt{_v1}::}@common_iterator<I, @\newtxt{experimental::ranges\oldtxt{_v1}::}@unreachable>;
...
concept bool InputRange@\newtxt{() \{}\oldtxt{ =}@
  @\newtxt{return}@ Range<T>@\newtxt{()}@ && InputIterator<@\oldtxt{IteratorType}\newtxt{iterator_t}@<T>>@\newtxt{()}@;
@\newtxt{\}}@
\end{codeblock}
...
concept bool BidirectionalRange@\newtxt{() \{}\oldtxt{ =}@
  @\newtxt{return}@ ForwardRange<T>@\newtxt{()}@ && BidirectionalIterator<@\oldtxt{IteratorType}\newtxt{iterator_t}@<T>>@\newtxt{()}@;
@\newtxt{\}}@
\end{codeblock}
...
concept bool RandomAccessRange@\newtxt{() \{}\oldtxt{ =}@
  @\newtxt{return}@ BidirectionalRange<T>@\newtxt{()}@ && RandomAccessIterator<@\oldtxt{IteratorType}\newtxt{iterator_t}@<T>>@\newtxt{()}@;
@\newtxt{\}}@
\end{codeblock}
