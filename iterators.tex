...
the syntactic requirements of \tcode{SizedRange}, or \tcode{disable_sized_range<T>::value}
is \tcode{true}~(\ref{sized.iterables}).}
\end{itemize}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\newtxt{Given an object \tcode{t} of type \tcode{T}, \tcode{SizedRange<T>()}
is satisfied if and only if \tcode{size(t)} returns the number of elements in
\tcode{t}.}
...
syntactic requirements of \tcode{SizedRange}}. \exitnote
