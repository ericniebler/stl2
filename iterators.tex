  ...
  concept bool WeakInputIterator() {
    return WeakIterator<I>() &&
      ...
      requires(I i, const I ci) {
        ...
        requires DerivedFrom<@\oldtxt{IteratorCategory}\newtxt{iterator_category_t}@<I>, weak_input_iterator_tag>();
...
\begin{codeblock}
  ...
  concept bool InputIterator() {
    return WeakInputIterator<I>() &&
      Iterator<I>() &&
      DerivedFrom<@\oldtxt{IteratorCategory}\newtxt{iterator_category_t}@<I>, input_iterator_tag>();
  }
\end{codeblock}
...
\begin{codeblock}
  ...
  template <class WeakInputIterator> using @\oldtxt{IteratorCategory}\newtxt{iterator_category_t}@
