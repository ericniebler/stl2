...
\begin{codeblock}
  ...
  template <WeakInputIterator I1, WeakInputIterator I2>
    common_type_t<DifferenceType<I1>, DifferenceType<I2>> operator-(
      const counted_iterator<I1>& x, const counted_iterator<I2>& y);
  template <WeakInputIterator I>
  ...
  template <WeakInputIterator I>
    DifferenceType<I> operator-(
      counted_sentinel x, const counted_iterator<I>& y);
  constexpr ptrdiff_t operator-(counted_sentinel x, counted_sentinel y);
  ...
  template <WeakInputIterator I, Sentinel<I> S> class common_iterator;
  template <WeakInputIterator I1, Sentinel<I1> S1,
            WeakInputIterator I2, Sentinel<I2> S2>
      requires EqualityComparable<I1, I2> && EqualityComparable<S1, S2>
    bool operator==(
...
\pnum
\tcode{ValueType<T>} is implemented as if:
