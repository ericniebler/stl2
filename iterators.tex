...
\begin{codeblock}
  ...
  @\newtxt{template <WeaklyIncrementable I1, WeaklyIncrementable I2>}@
  @\newtxt{using \xname{common_difference_type_t} = \seebelow; // \expos}@

  @\newtxt{template <class I1, class S1, class I2, class S2>}@
  @\newtxt{concept bool \xname{CommonSizedIteratorRange}() \{ // \expos}@
  ...
  template <@\oldtxt{InputIterator}\newtxt{class}@ I1, @\oldtxt{\xname{WeakSentinel}<I1>}\newtxt{class}@ S1,
    ...
    @\oldtxt{requires SizedIteratorRange<I1, I1>() \&\& SizedIteratorRange<I2, I2>() \&\&}@
      ...
      @\oldtxt{\}}@
    @\newtxt{requires \xname{CommonSizedIteratorRange}<I1, S1, I2, S2>()}@
  @\oldtxt{DifferenceType<I2>}\newtxt{\xname{common_difference_type_t}<I1, I2>}@ operator-(
    const common_iterator<I1, S1>& x, const common_iterator<I2, S2>& y);
...
Insert iterators satisfy \oldtxt{the requirements of output iterators}{\newtxt{\tcode{WeakOutputIterator}}.
\tcode{operator*}
...
namespace std { namespace experimental { namespace ranges@\oldtxt{_v1} \newtxt{\{ inline namespace v1}@ {
  ...
  @\newtxt{template <WeaklyIncrementable I1, WeaklyIncrementable I2>}@
  @\newtxt{using \xname{common_difference_type_t} = // \expos}@
    @\newtxt{common_type_t<difference_type_t<I1>, difference_type_t<I2>{}>;}@

  @\newtxt{template <class I1, class S1, class I2, class S2>}@
  @\newtxt{concept bool \xname{CommonSizedIteratorRange}() \{ // \expos}@
    @\newtxt{return SizedIteratorRange<I1, I1>() \&\& SizedIteratorRange<I2, I2>() \&\&}@
      @\newtxt{requires (const I1 i1, const S1 s1, const I2 i2, const S2 s2) \{}@
        @\newtxt{\{i1-i2\}->\xname{common_difference_type_t}<I1, I2>; \{i2-i1\}->\xname{common_difference_type_t}<I1, I2>;}@
        @\newtxt{\{i1-s2\}->\xname{common_difference_type_t}<I1, I2>; \{s2-i1\}->\xname{common_difference_type_t}<I1, I2>;}@
        @\newtxt{\{i2-s1\}->\xname{common_difference_type_t}<I1, I2>; \{s1-i2\}->\xname{common_difference_type_t}<I1, I2>;}@
      @\newtxt{\};}@
  @\newtxt{\}}@
...
\item if \tcode{I} is a pointer type or if the expression
      \tcode{i.operator->()} is a well-formed expression, this function returns
      \tcode{iter}.
\item Otherwise, if the expression \tcode{*iter} is an lvalue, this function
...
namespace std { namespace experimental { namespace ranges@\oldtxt{_v1} \newtxt{\{ inline namespace v1}@ {
  ...
  public:
    ...
    counted_iterator& operator-=(difference_type n)
      requires RandomAccessIterator<I>();
    @\oldoldtxt{\unspec}\newnewtxt{\seebelow}@ operator[](difference_type n) const
      requires RandomAccessIterator<I>();
  @\oldoldtxt{protected}\newnewtxt{private}@:
    I current; @\newtxt{// \expos}@
...
\newtxt{
\note The argument order in the \textit{Effects} clause are reversed because \tcode{cnt}
counts down, not up.
}
\end{itemdescr}
