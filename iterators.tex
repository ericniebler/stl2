...
\begin{codeblock}
  template <Readable I, IndirectRegularCallable<I> Proj>
    requires RegularFunction<FunctionType<Proj>, ReferenceType<I>>
  struct Projected {
...
\tcode{n} applications of \tcode{++a}, \tcode{bool(a == b)}. Then \tcode{SizedIteratorRange<I, S>()}
...
\begin{codeblock}
namespace std { @\added{namespace experimental \{ namespace ranges_v1 \{}@
  ...
  template <InputIterator I1, @\xname{WeakSentinel}@<I1> S1,
    ...
    requires SizedIteratorRange<I1, I1>() && SizedIteratorRange<I2, I2>() &&
      requires (const I1 i1, const S1 s1, const I2 i2, const S2 s2) {
        {i1-i2}->DifferenceType<I2>; {i2-i1}->DifferenceType<I2>;
        {i1-s2}->DifferenceType<I2>; {s2-i1}->DifferenceType<I2>;
        {i2-s1}->DifferenceType<I2>; {s1-i2}->DifferenceType<I2>;
      }
...
\pnum
\enternote
\tcode{iterator_traits} is an alias template to intentionally break code that tries to specialize
it.
\exitnote
