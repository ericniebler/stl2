...
\pnum
\removed{An iterator }\oldtxt{or }\added{A }\added{sentinel}
...
A
\term{range}
is \removed{a pair of iterators }\oldtxt{or }\added{an iterator and a sentinel} that designate the beginning and end of the computation.
