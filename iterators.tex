...
\tcode{true_type} if \tcode{T} \oldtxt{models}\newtxt{meets the syntactic requirements of}
\tcode{\xname{SizedRangeLike}}, and \tcode{false_type} otherwise.
...
to override the default in the case of accidental \newtxt{syntactic}
conformance. \exitnote
