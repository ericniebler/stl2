...
\item If \tcode{i} is incrementable, then either \tcode{++i} or \tcode{i++} moves \tcode{i} to the next element.
...
may be compared and shall compare equal\removed{ to other value-initialized iterators of the same type}.
