...
\newtxt{after the assignment \tcode{*o = v},}

\begin{itemize}
\item \tcode{v} is unchanged.
\item If \tcode{Out} is \tcode{Readable}, \oldtxt{after the assignment \tcode{*o = v},}
...
Let \tcode{i} be an object of type \tcode{I}, and let \tcode{o} be a
dereferenceable object of type \tcode{Out}. Then types \tcode{I} and \tcode{Out} model
\tcode{IndirectlyCopyable} if and only if \newtxt{after the assignment \tcode{*o = *i},}

\begin{itemize}
\item The value of \tcode{*i} is unchanged.
\item If \tcode{Out} is \tcode{Readable}, \oldtxt{after the assignment \tcode{*o = *i},}
...
supersedes the annotation on the increment expressions in the definition of
...
\item If \tcode{\newtxt{bool}(a == b)\oldtxt{ != false}} then \tcode{\newtxt{bool}((a++, a) == (b++, b))\oldtxt{ != false}}.
\item If \tcode{\newtxt{bool}(a == b)\oldtxt{ != false}} then \tcode{\newtxt{bool}(a++ == b)\oldtxt{ != false}}.
...
\term{single pass}
algorithms.
Value type T is not required to be a \oldoldtxt{\tcode{CopyAssignable}} \newtxt{\tcode{Copyable}}
  ...
  concept bool RandomAccessIterator@\newtxt{() \{}\oldtxt{ =}@
    @\newtxt{return}@ BidirectionalIterator<I>@\newtxt{()}@ &&
      ...
      requires (I i, I j, DifferenceType<I> n) {
        ...
        { i -= n } -> Same<I&>;
        { i - n } -> Same<I>;
        @\newtxt{\{ i[n] \} -> const ValueType<I>\&;}@
      @\newtxt{\} \&\&}@
      (@\newtxt{!}\xname{MutableIterator}@<I> @\oldtxt{?}\newtxt{||}@
        requires(I i, @\oldtxt{int}\newtxt{DifferenceType<I>}@ n) { i[n] = *i; *i = i[n]; }@\oldtxt{ :}\newtxt{);}@
