...
relation, the value type must satisfy \tcode{\added{Strict}TotallyOrdered}.\exitnote
...
\pnum
The \tcode{Sortable} concept specifies the common requirements
...
\tcode{\oldtxt{DifferenceType<I>}}\tcode{\newtxt{difference_type_t<I>}} such that after
\tcode{n} applications of \tcode{++a}, \tcode{bool(a == b)}. Then
...
\begin{codeblock}
  ...
  template <@\changed{class Iterator1}{RandomAccessIterator I1}@, @\changed{class Iterator2}{RandomAccessIterator I2}@>
      @\added{requires \added{Strict}TotallyOrdered<I1, I2>()}@
    bool operator<(
      const reverse_iterator<@\changed{Iterator1}{I1}@>& x,
      const reverse_iterator<@\changed{Iterator2}{I2}@>& y);
  template <@\changed{class Iterator1}{BidirectionalIterator I1}@, @\changed{class Iterator2}{BidirectionalIterator I2}@>
