...
\ednote{BUGBUG What does ``move to the next element'' mean?}
...
\ednote{BUGBUG and \tcode{-} for two iterators}
...
\rSec2[mergemovable.commmonalgoreq]{MergeMovable iterators}
...
\begin{codeblock}
  ...
  @\ednote{TODO: Why not WeakIterator?}@
