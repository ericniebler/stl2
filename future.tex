...
that could solve the problem. Some \tcode{\newtxt{Weakly}Incrementable}s are finitely countable with a built-in
integral \tcode{\oldtxt{DifferenceType}\brk{}\newtxt{difference_type_t}}, and some are not.
