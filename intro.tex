...
\item are declared in a namespace whose name appends \tcode{::experimental::ranges\oldtxt{_v1}\newtxt{::v1}} to
...
\tcode{std::experimental::ranges\oldtxt{_v1}\newtxt{::v1}::relops} exists.}

\enterexample This TS does not define \tcode{std::experimental::ranges\oldtxt{_v1}\newtxt{::v1}::chrono} because
the C++ Standard Library defines \tcode{std::chrono}. This paper does not define
\tcode{std::pmr::experimental::ranges\oldtxt{_v1}\newtxt{::v1}} because the C++ Standard Library does not define
