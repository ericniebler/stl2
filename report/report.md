...
## Notable editorial changes:
  * [f880d726](https://github.com/ericniebler/stl2/commit/f880d726555bb24762cf9f9ae607dc60ae4e6814) [EDITORIAL] s/Callable/Invocable/g

    The earlier change that replaced (nearly) all uses of `Callable` concepts with `Invocable` concepts missed that the `generate(_n)?` algorithms were constrained with `Callable`.
