...
namespace std {
  ...
  \end{codeblock}
  \ednote{Still need to fix up return types here}
  \begin{codeblock}

  // \ref{alg.nonmodifying}, non-modifying sequence operations:
  template <InputIterator I, Sentinel<I> S, class Pred,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires InvokablePredicate<Pred, invokable_result_t<Proj, iterator_value_t<I>>>
  ...
  template <InputIterator I, Sentinel<I> S, class Pred,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires InvokablePredicate<Pred,
      invokable_result_t<Proj, iterator_value_t<I>>>
    bool none_of(I first, S last, Pred pred, Proj proj = Proj{});

  template<InputIterator I, Sentinel<I> S, class Fun,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires InvokableFunction<Fun,
      invokable_result_t<Proj, iterator_value_t<I>>>
    Fun for_each(I first, S last, Fun f, Proj proj = Proj{});
  ...
  template<InputIterator I, Sentinel<I> S, class Pred,
    ...
    requires InvokablePredicate<Pred,
      invokable_result_t<Proj, iterator_value_t<I>>>
    I find_if_not(I first, S last,
                  Pred pred, Proj proj = Proj{});

  template<ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2,
      Sentinel<I2> S2, class BinaryPred = equal_to<>,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires InvokableRelation<Pred, iterator_value_t<I2>,
      invokable_result_t<Proj, iterator_value_t<I>>>
    I1
      find_end(I1 first1, S1 last1,
               I2 first2, S2 last2,
               BinaryPred pred = BinaryPred{}, Proj proj = Proj{});

  template<InputIterator I1, Sentinel<I1> S1,
     ForwardIterator I2, Sentinel<I2> S2,
     class BinaryPred = equal_to<>,
     Invokable<iterator_value_t<I1>> Proj1 = identity,
     Invokable<iterator_value_t<I2>> Proj2 = identity>
    requires InvokablePredicate<Pred,
      invokable_result_of_t<Proj1(iterator_value_t<I1>)>,
      invokable_result_of_t<Proj2(iterator_value_t<I2>)>>
    I1
      find_first_of(I1 first1, S1 last1,
                    I2 first2, S2 last2,
  ...
  template<ForwardIterator I, Sentinel<I> S,
     class BinaryPred = equal_to<>, Invokable<iterator_value_t<I>> Proj = identity>
    requires Invokable<Proj, iterator_value_t<I>> &&
      InvokableRelation<BinaryPred,
        invokable_result_t<Proj, iterator_value_t<I>>>
    I
  ...
  template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,
     ...
     Invokable<iterator_value_t<I1>> Proj1 = identity,
     Invokable<iterator_value_t<I2>> Proj2 = identity>
    requires InvokablePredicate<BinaryPred,
      invokable_result_t<Proj1, iterator_value_t<I1>>,
      invokable_result_t<Proj2, iterator_value_t<I2>>>
    pair<I1, I2>
      mismatch(I1 first1, S1 last1,
               I2 first2, BinaryPred pred = BinaryPred{},
  ...
  \end{codeblock}\ednote{Move me:}\begin{codeblock}
  concept IndirectlyComparable<WeakInputIterator I1,
      WeakInputIterator I2, class BinaryPred = equal_to<>,
      Invokable<iterator_value_t<I1>> Proj1 = identity,
      Invokable<iterator_value_t<I2>> Proj2 = identity> =
    InvokableRelation<BinaryPred,
      invokable_result_t<Proj1, iterator_value_t<I1>>,
  ...
  template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,
      ...
      Invokable<iterator_value_t<I1>> Proj1 = identity,
      Invokable<iterator_value_t<I2>> Proj2 = identity>
    requires IndirectlyComparable<I1, I2, BinaryPred, Proj1, Proj2>
  ...
  template<ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2,
      ...
      Invokable<iterator_value_t<I2>> Proj2 = identity>
    requires IndirectlyComparable<I1, I2, BinaryPred, Proj1, Proj2>
    bool is_permutation(I1 first1, S1 last1,
                        I2 first2, BinaryPred pred = BinaryPred{},
                        Proj1 proj1 = Proj1{}, Proj2 proj2 = Proj2{});
  ...
  template<ForwardIterator I, Sentinel<I> S, class T,
      class BinaryPred = equal_to<>,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires IndirectlyComparable<I1, const T*, BinaryPred, Proj1>
    I search_n(I first, S last,
               iterator_difference_t<I> count,
               const T& value,
               BinaryPred pred = BinaryPred{},
               Proj proj = Proj{});
  ...
  template<InputIterator I, Sentinel<I> S, WeakIterator O,
    ...
    O copy(I first, S last, O result, Proj proj = Proj{});

  template<WeakInputIterator I, WeakIterator O,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires IndirectlyCopyable<I, O, Proj>
    pair<I, O>
      copy_n(I first, iterator_distance_t<I> n,
             O result, Proj proj = Proj{});

  template<InputIterator I, Sentinel<I> S, WeakIterator O,
      class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    requires IndirectlyCopyable<I, O, Proj> &&
      InvokablePredicate<Pred,
        invokable_result_t<Proj, iterator_value_t<I>>>
    O
      copy_if(I first, S last,
              O result, Pred pred, Proj proj = Proj{});
  ...
  template<ForwardIterator I1, Sentinel<I1> S1,
    ...
    requires IndirectlySwappable<I1, I2>
    I2
      swap_ranges(I1 first1, S1 last1,
                  I2 first2, S2 last2);

  template<InputIterator I, Sentinel<I> S, WeakIterator O,
      class UnaryOperation,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires Invokable<UnaryOperation,
        iterable_result_t<Proj, iterator_value_t<I>>> &&
      Writable<O, invokable_result_t<UnaryOperation,
        iterable_result_t<Proj, iterator_value_t<I>>>>
    O
      transform(I first, S last, O result,
                UnaryOperation op, Proj proj = Proj{});

  template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,
      WeakIterator O, class BinaryOperation,
      Invokable<iterator_value_t<I1>> Proj1 = identity,
      Invokable<iterator_value_t<I2>> Proj2 = identity>
    requires Writable<O, invokable_result_t<
        BinaryOperation,
  ...
  template<InputIterator I1, Sentinel<I1> S1,
      InputIterator I2, Sentinel<I2> S2, WeakIterator O,
    ...
    O
      transform(I1 first1, S1 last1,
                I2 first2, S2 last2, O result,
                BinaryOperation binary_op,
                Proj1 proj1 = Proj1{}, proj2 proj2 = Proj2{});

  \end{codeblock}
  \ednote{In the Palo Alto proposal, \tcode{replace} requires only InputIterators.
      In C++14, it requires Forward. I assume it is because op* is used
      twice. Resolve the conflict.}
  \begin{codeblock}

  template<ForwardIterator I, Sentinel<I> S, class T1, class T2,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires Writable<I, T2> && EqualityComparable<T1,
        invokable_result_t<Proj, iterator_value_t<I>>>
    I
      replace(I first, S last,
              const T1& old_value, const T2& new_value);

  template<ForwardIterator I, Sentinel<I> S, class Pred, class T,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires Writable<I, T> && InvokablePredicate<Pred,
        invokable_result_t<Proj, iterator_value_t<I>>>
    I
      replace_if(I first, S last,
                 Pred pred, const T& new_value,
                 Proj proj = Proj{});

  template<InputIterator I, Sentinel<I> S, WeakIterator O, class T1,
      class T2, Invokable<iterator_value_t<I>> Proj = identity>
    requires Writable<O, T2> && EqualityComparable<T1,
        invokable_result_t<Proj, iterator_value_t<I>>>
    O
      replace_copy(I first, S last, O result,
                   const T1& old_value, const T2& new_value,
                   Proj proj = Proj{});
  ...
  template<InputIterator I, Sentinel<I> S, WeakIterator O,
      class Pred, class T,
      Invokable<iterator_value_t<I>> Proj = identity>
    requires Writable<O, T> && InvokablePredicate<Pred,
        invokable_result_t<Proj, iterator_value_t<I>>>
    O
      replace_copy_if(I first, S last,
                      O result, Pred pred, const T& new_value,
                      Proj proj = Proj{});
  ...
  \end{codeblock}
  \ednote{Below are unfinished}
  \begin{codeblock}

  template<ForwardIterator I, Sentinel<I> S, class Generator>
    void generate(I first, S last,
                  Generator gen);
  template<OutputIterator<iterator_value_t<I>> O, class Size, class Generator>
    O generate_n(I first, Size n, Generator gen);

  template<ForwardIterator I, Sentinel<I> S, class T>
    ForwardIterator remove(I first, S last,
                           const T& value);
  template<ForwardIterator I, Sentinel<I> S, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator remove_if(I first, S last,
                              Pred pred, Proj proj = Proj{});
  template<InputIterator I, Sentinel<I> S, OutputIterator<iterator_value_t<I>> O, class T>
    O remove_copy(I first, S last,
                               O result, const T& value);
  template<InputIterator I, Sentinel<I> S, OutputIterator<iterator_value_t<I>> O, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    O remove_copy_if(I first, S last,
                                  O result, Pred pred, Proj proj = Proj{});

  template<ForwardIterator I, Sentinel<I> S>
    I unique(I first, S last);
  template<ForwardIterator I, Sentinel<I> S, class BinaryPred, Invokable<iterator_value_t<I>> Proj = identity>
    I unique(I first, S last,
                           BinaryPred pred, Proj proj = Proj{});
  template<InputIterator I, Sentinel<I> S, OutputIterator<iterator_value_t<I>> O>
    O unique_copy(I first, S last,
                               O result);
  template<InputIterator I, Sentinel<I> S, OutputIterator<iterator_value_t<I>> O, class BinaryPred, Invokable<iterator_value_t<I>> Proj = identity>
    O unique_copy(I first, S last,
                               O result, BinaryPred pred, Proj proj = Proj{});

  template<BidirectionalIterator I, Sentinel<I> S>
    void reverse(I first, S last);
  template<BidirectionalIterator I, Sentinel<I> S, OutputIterator<iterator_value_t<I>> O>
    O reverse_copy(I first,
                                S last,
                                O result);

  template<ForwardIterator I, Sentinel<I> S>
    ForwardIterator rotate(I first, ForwardIterator middle,
                           S last);
  template<ForwardIterator I, Sentinel<I> S, OutputIterator<iterator_value_t<I>> O>
    O rotate_copy(
      I first, ForwardIterator middle,
      S last, O result);

  // \ref{depr.alg.random.shuffle}, random_shuffle (deprecated):
  template<RandomAccessIterator I, Sentinel<I> S>
    void random_shuffle(I first,
                        S last);
  template<RandomAccessIterator I, Sentinel<I> S, class RandomNumberGenerator>
    void random_shuffle(I first,
                        S last,
                        RandomNumberGenerator&& rng);

  // \ref{alg.random.shuffle}, shuffle:
  template<RandomAccessIterator I, Sentinel<I> S, class UniformRandomNumberGenerator>
    void shuffle(I first,
                        S last,
                        UniformRandomNumberGenerator&& g);

  // \ref{alg.partitions}, partitions:
  template <InputIterator I, Sentinel<I> S, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    bool is_partitioned(I first, S last, Pred pred, Proj proj = Proj{});

  template<ForwardIterator I, Sentinel<I> S, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator partition(I first,
                              S last,
                              Pred pred, Proj proj = Proj{});
  template<BidirectionalIterator I, Sentinel<I> S, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    BidirectionalIterator stable_partition(I first,
                                           S last,
                                           Pred pred, Proj proj = Proj{});
  template <InputIterator I, Sentinel<I> S, O I1, Sentinel<I1> S1,
            O I2, Sentinel<I2> S2, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    pair<OutputIterator1, OutputIterator2>
    partition_copy(I first, S last,
                   OutputIterator1 out_true, OutputIterator2 out_false,
                   Pred pred, Proj proj = Proj{});
  template<ForwardIterator I, Sentinel<I> S, class Pred, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator partition_point(I first,
                                    S last,
                                    Pred pred, Proj proj = Proj{});
  ...
  template<RandomAccessIterator I, Sentinel<I> S>
    void sort(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void sort(I first, S last,
              Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    void stable_sort(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void stable_sort(I first, S last,
                     Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    void partial_sort(I first,
                      RandomAccessIterator middle,
                      S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void partial_sort(I first,
                      RandomAccessIterator middle,
                      S last, Comp comp, Proj proj = Proj{});
  template<InputIterator I, Sentinel<I> S, RandomAccessIterator I, Sentinel<I> S>
    RandomAccessIterator partial_sort_copy(
      I first, S last,
      RandomAccessIterator result_first,
      RandomAccessIterator result_last);
  template<InputIterator I, Sentinel<I> S, RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    RandomAccessIterator partial_sort_copy(
      I first, S last,
      RandomAccessIterator result_first,
      RandomAccessIterator result_last,
      Comp comp, Proj proj = Proj{});
  template<ForwardIterator I, Sentinel<I> S>
    bool is_sorted(I first, S last);
  template<ForwardIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    bool is_sorted(I first, S last,
                   Comp comp, Proj proj = Proj{});
  template<ForwardIterator I, Sentinel<I> S>
    ForwardIterator is_sorted_until(I first, S last);
  template<ForwardIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator is_sorted_until(I first, S last,
                                    Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    void nth_element(I first, RandomAccessIterator nth,
                     S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void nth_element(I first, RandomAccessIterator nth,
                     S last, Comp comp, Proj proj = Proj{});
  ...
  template<ForwardIterator I, Sentinel<I> S, class T>
    ForwardIterator lower_bound(I first, S last,
                                const T& value);
  template<ForwardIterator I, Sentinel<I> S, class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator lower_bound(I first, S last,
                                const T& value, Comp comp, Proj proj = Proj{});

  template<ForwardIterator I, Sentinel<I> S, class T>
    ForwardIterator upper_bound(I first, S last,
                                const T& value);
  template<ForwardIterator I, Sentinel<I> S, class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator upper_bound(I first, S last,
                                const T& value, Comp comp, Proj proj = Proj{});
  ...
  template<ForwardIterator I, Sentinel<I> S, class T>
    bool binary_search(I first, S last,
                       const T& value);
  template<ForwardIterator I, Sentinel<I> S, class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    bool binary_search(I first, S last,
                       const T& value, Comp comp, Proj proj = Proj{});
  ...
  // \ref{alg.merge}, merge:
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2, OutputIterator<iterator_value_t<I>> O>
    O merge(I1 first1, S1 last1,
                         I2 first2, S2 last2,
                         O result);
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2, OutputIterator<iterator_value_t<I>> O,
     class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    O merge(I1 first1, S1 last1,
                         I2 first2, S2 last2,
                         O result, Comp comp, Proj proj = Proj{});

  template<BidirectionalIterator I, Sentinel<I> S>
    void inplace_merge(I first,
                       BidirectionalIterator middle,
                       S last);
  template<BidirectionalIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void inplace_merge(I first,
                       BidirectionalIterator middle,
                       S last, Comp comp, Proj proj = Proj{});
  ...
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2>
    bool includes(I1 first1, S1 last1,
                  I2 first2, S2 last2);
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    bool includes(
      I1 first1, S1 last1,
      I2 first2, S2 last2, Comp comp, Proj proj = Proj{});

  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2, OutputIterator<iterator_value_t<I>> O>
    O set_union(I1 first1, S1 last1,
                             I2 first2, S2 last2,
                             O result);
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2, OutputIterator<iterator_value_t<I>> O,
     class Comp, Invokable<iterator_value_t<I>> Proj = identity>
  ...
  template<RandomAccessIterator I, Sentinel<I> S>
    void push_heap(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void push_heap(I first, S last,
                   Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    void pop_heap(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void pop_heap(I first, S last,
                  Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    void make_heap(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void make_heap(I first, S last,
                   Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    void sort_heap(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    void sort_heap(I first, S last,
                   Comp comp, Proj proj = Proj{});

  template<RandomAccessIterator I, Sentinel<I> S>
    bool is_heap(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    bool is_heap(I first, S last, Comp comp, Proj proj = Proj{});
  template<RandomAccessIterator I, Sentinel<I> S>
    RandomAccessIterator is_heap_until(I first, S last);
  template<RandomAccessIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    RandomAccessIterator is_heap_until(I first, S last,
                                       Comp comp, Proj proj = Proj{});
  ...
  template<class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    constexpr const T& min(const T& a, const T& b, Comp comp, Proj proj = Proj{});
  template<class T>
    constexpr T min(initializer_list<T> t);
  template<class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    constexpr T min(initializer_list<T> t, Comp comp, Proj proj = Proj{});

  template<class T> constexpr const T& max(const T& a, const T& b);
  template<class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    constexpr const T& max(const T& a, const T& b, Comp comp, Proj proj = Proj{});
  template<class T>
    constexpr T max(initializer_list<T> t);
  template<class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    constexpr T max(initializer_list<T> t, Comp comp, Proj proj = Proj{});

  template<class T> constexpr pair<const T&, const T&> minmax(const T& a, const T& b);
  template<class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    constexpr pair<const T&, const T&> minmax(const T& a, const T& b, Comp comp, Proj proj = Proj{});
  template<class T>
    constexpr pair<T, T> minmax(initializer_list<T> t);
  template<class T, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    constexpr pair<T, T> minmax(initializer_list<T> t, Comp comp, Proj proj = Proj{});

  template<ForwardIterator I, Sentinel<I> S>
    ForwardIterator min_element(I first, S last);
  template<ForwardIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator min_element(I first, S last,
                                Comp comp, Proj proj = Proj{});
  template<ForwardIterator I, Sentinel<I> S>
    ForwardIterator max_element(I first, S last);
  template<ForwardIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    ForwardIterator max_element(I first, S last,
                                Comp comp, Proj proj = Proj{});
  template<ForwardIterator I, Sentinel<I> S>
    pair<ForwardIterator, ForwardIterator>
      minmax_element(I first, S last);
  template<ForwardIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    pair<ForwardIterator, ForwardIterator>
      minmax_element(I first, S last, Comp comp, Proj proj = Proj{});
  ...
  template<BidirectionalIterator I, Sentinel<I> S>
    bool next_permutation(I first,
                          S last);
  template<BidirectionalIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    bool next_permutation(I first,
                          S last, Comp comp, Proj proj = Proj{});
  template<BidirectionalIterator I, Sentinel<I> S>
    bool prev_permutation(I first,
                          S last);
  template<BidirectionalIterator I, Sentinel<I> S, class Comp, Invokable<iterator_value_t<I>> Proj = identity>
    bool prev_permutation(I first,
                          S last, Comp comp, Proj proj = Proj{});
