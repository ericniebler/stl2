...
\begin{codeblock}
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Proj = identity,
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng2, class Proj = identity,
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng2, class Proj1 = identity,
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, WeakInputIterator I2,
      class Proj1 = identity, class Proj2 = identity,
      IndirectCallablePredicate<Projected<IteratorType<Rng1>, Proj1>,
        Projected<I2, Proj2>> Pred = equal_to<>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::in1(}@IteratorType<Rng1>@\newtxt{)}@, @\newtxt{tag::in2(}@I2@\newtxt{)}@>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Input@\oldtxt{Iterable}\newtxt{Range}@ Rng2,
      class Proj1 = identity, class Proj2 = identity,
      IndirectCallablePredicate<Projected<IteratorType<Rng1>, Proj1>,
        Projected<IteratorType<Rng2>, Proj2>> Pred = equal_to<>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::in1(}@IteratorType<Rng1>@\newtxt{)}@, @\newtxt{tag::in2(}@IteratorType<Rng2>@\newtxt{)}@>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, WeakInputIterator I2, class Pred = equal_to<>,
      class Proj1 = identity, class Proj2 = identity>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Input@\oldtxt{Iterable}\newtxt{Range}@ Rng2, class Pred = equal_to<>,
      class Proj1 = identity, class Proj2 = identity>
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng1, ForwardIterator I2, class Pred = equal_to<>,
      class Proj1 = identity, class Proj2 = identity>
    requires IndirectlyComparable<IteratorType<Rng1>, I2, Pred, Proj1, Proj2>
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, class T, class Pred = equal_to<>,
      class Proj = identity>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, WeaklyIncrementable O>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, WeaklyIncrementable O, class Proj = identity,
      IndirectCallablePredicate<Projected<IteratorType<Rng>, Proj>> Pred>
    requires IndirectlyCopyable<IteratorType<Rng>, O>
    @\newtxt{tagged_}@pair<@\newtxt{tag::in(}@IteratorType<Rng>@\newtxt{)}@, @\newtxt{tag::out(}@O@\newtxt{)}@>
  ...
  template<Bidirectional@\oldtxt{Iterable}\newtxt{Range}@ Rng, BidirectionalIterator I>
    requires IndirectlyCopyable<IteratorType<Rng>, I>
    @\newtxt{tagged_}@pair<@\newtxt{tag::in1(}@IteratorType<Rng>@\newtxt{)}@, @\newtxt{tag::in2(}@I@\newtxt{)}@>
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, ForwardIterator I>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, WeakInputIterator I,
      class Proj1 = identity, class Proj2 = identity,
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, Semiregular T, class Proj = identity,
      IndirectCallablePredicate<Projected<IteratorType<Rng>, Proj>> Pred>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, Semiregular T, WeakOutputIterator<T> O, class Proj = identity,
      IndirectCallablePredicate<Projected<IteratorType<Rng>, Proj>> Pred>
    requires IndirectlyCopyable<IteratorType<Rng>, O>
    @\newtxt{tagged_}@pair<@\newtxt{tag::in(}@IteratorType<Rng>@\newtxt{)}@, @\newtxt{tag::out(}@O@\newtxt{)}@>
  ...
  template<Semiregular T, Output@\oldtxt{Iterable}\newtxt{Range}@<T> Rng>
    IteratorType<Rng>
  ...
  template<Function F, Output@\oldtxt{Iterable}\newtxt{Range}@<ResultType<F>> Rng>
    IteratorType<Rng>
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng>
    requires Permutable<IteratorType<Rng>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::begin(}@IteratorType<Rng>@\newtxt{)}@, @\newtxt{tag::end(}@IteratorType<Rng>@\newtxt{)}@>
  ...
  template<RandomAccessIterator I, Sentinel<I> S, @\oldtxt{UniformRandomNumberGenerator}\newtxt{class}@ Gen>
    requires Permutable<I> && Convertible<ResultType<Gen>, DifferenceType<I>>@\newtxt{ \&\&}@
      @\newtxt{UniformRandomNumberGenerator<remove_reference_t<Gen>{}>}@
    I shuffle(I first, S last, Gen&& g);

  template<RandomAccess@\oldtxt{Iterable}\newtxt{Range}@ Rng, @\oldtxt{UniformRandomNumberGenerator}\newtxt{class}@ Gen>
    requires Permutable<I> && Convertible<ResultType<Gen>, DifferenceType<I>>@\newtxt{ \&\&}@
      @\newtxt{UniformRandomNumberGenerator<remove_reference_t<Gen>{}>}@
    IteratorType<Rng>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, WeaklyIncrementable O1, WeaklyIncrementable O2,
      class Proj = identity,
      IndirectCallablePredicate<Projected<IteratorType<Rng>, Proj>> Pred>
  ...
  template<RandomAccess@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Comp = less<>, class Proj = identity>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, RandomAccess@\oldtxt{Iterable}\newtxt{Range}@ Rng2, class R = less<>,
      class Proj = identity>
  ...
  template<ForwardIterator I, Sentinel<I> S, class Proj = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<I, Proj>> Comp = less<>>
    bool is_sorted(I first, S last, Comp comp = Comp{}, Proj proj = Proj{});

  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Proj = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<IteratorType<Rng>, Proj>> Comp = less<>>
    bool
  ...
  template<ForwardIterator I, Sentinel<I> S, TotallyOrdered T, class Proj = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<const T *, Projected<I, Proj>> Comp = less<>>
    I
      lower_bound(I first, S last, const T& value, Comp comp = Comp{},
                  Proj proj = Proj{});

  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, TotallyOrdered T, class Proj = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<const T *, Projected<IteratorType<Rng>, Proj>> Comp = less<>>
    IteratorType<Rng>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Input@\oldtxt{Iterable}\newtxt{Range}@ Rng2, Incrementable O, class Comp = less<>,
      class Proj1 = identity, class Proj2 = identity>
  ...
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2,
      class Proj1 = identity, class Proj2 = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<I1, Proj1>, Projected<I2, Proj2>> Comp = less<>>
    bool
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Input@\oldtxt{Iterable}\newtxt{Range}@ Rng2, class Proj1 = identity,
      class Proj2 = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<IteratorType<Rng1>, Proj1>,
  ...
  template<InputIterator I1, Sentinel<I1> S1, InputIterator I2, Sentinel<I2> S2,
      WeaklyIncrementable O, @\newtxt{class Comp = less<>, }@class Proj1 = identity, class Proj2 = identity@\oldtxt{,}\newtxt{>}@
      @\oldtxt{IndirectCallableRelation<Projected<I1, Proj1>, Projected<I2, Proj2>> Comp = less<> >}@
    requires Mergeable<I1, I2, O, Comp, Proj1, Proj2>
    @\newtxt{tagged_}@tuple<@\newtxt{tag::in1(}@I1@\newtxt{)}@, @\newtxt{tag::in2(}@I2@\newtxt{)}@, @\newtxt{tag::out(}@O@\newtxt{)}@>
      set_union(I1 first1, S1 last1, I2 first2, S2 last2, O result, Comp comp = Comp{},
                Proj1 proj1 = Proj1{}, Proj2 proj2 = Proj2{});

  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Input@\oldtxt{Iterable}\newtxt{Range}@ Rng2, WeaklyIncrementable O,
      @\newtxt{class Comp = less<>, }@class Proj1 = identity, class Proj2 = identity@\oldtxt{,}\newtxt{>}@
      @\oldtxt{IndirectCallableRelation<Projected<IteratorType<Rng1>, Proj1>,}@
        @\oldtxt{Projected<IteratorType<Rng2>, Proj2>> Comp = less<> >}@
    requires Mergeable<IteratorType<Rng1>, IteratorType<Rng2>, O, Comp, Proj1, Proj2>
    @\newtxt{tagged_}@tuple<@\newtxt{tag::in1(}@IteratorType<Rng1>@\newtxt{)}@, @\newtxt{tag::in2(}@IteratorType<Rng2>@\newtxt{)}@, @\newtxt{tag::out(}@O@\newtxt{)}@>
  ...
  template<class T, class Comp>
    requires @\oldtxt{Relation}\newtxt{StrictWeakOrder}@<FunctionType<Comp>, T>
...
\begin{codeblock}
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<IteratorType<Rng>> Comp>
  ...
  template<TotallyOrdered T>
    constexpr @\newtxt{tagged_}@pair<@\newtxt{tag::min(}@const T&@\newtxt{)}@, @\newtxt{tag::max(}@const T&@\newtxt{)}@>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng>
    requires TotallyOrdered<ValueType<IteratorType<Rng>>>() &&
      Semiregular<ValueType<IteratorType<Rng>>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::min(}@ValueType<IteratorType<Rng>>@\newtxt{)}@, @\newtxt{tag::max(}@ValueType<IteratorType<Rng>>@\newtxt{)}@>
      minmax(Rng&& rng);
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Proj = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<IteratorType<Rng>, Proj>> Comp = less<>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::min(}@IteratorType<Rng>@\newtxt{)}@, @\newtxt{tag::max(}@IteratorType<Rng>@\newtxt{)}@>
  ...
  template<BidirectionalIterator I, Sentinel<I> S, @\newtxt{class Comp = less<>,}@
      class Proj = identity@\oldtxt{, IndirectCallableRelation<Projected<I, Proj> > Comp = less<>}@>
    requires Sortable<I, Comp, Proj>
    bool next_permutation(I first, S last, Comp comp = Comp{}, Proj proj = Proj{});

  template<Bidirectional@\oldtxt{Iterable}\newtxt{Range}@ Rng, @\newtxt{class Comp = less<>,}@
      class Proj = identity@\oldtxt{, IndirectCallableRelation<Projected<IteratorType<Rng>, Proj> > Comp = less<>}@>
    requires Sortable<IteratorType<Rng>, Comp, Proj>
    bool
...
\pnum
Overloads of algorithms that take \tcode{\oldtxt{Iterable}\newtxt{Range}} arguments~(\ref{iterable.iterables})
behave as if they are implemented by calling \tcode{begin} and \tcode{end} on
the \tcode{\oldtxt{Iterable}\newtxt{Range}} and dispatching to the overload that takes separate
...
\pnum
\returns
\tcode{\changed{result + (last1 - first1)}{\oldtxt{make_pair(}\newtxt{\{}first1 + $N$, result + $N$\oldtxt{)}\newtxt{\}}}}
\added{ or }\tcode{\added{make_}}\tcode{\newtxt{tagged_}}\tcode{\added{tuple}}\brk\tcode{\newtxt{<tag::in1, tag::in2, tag::out>}}\tcode{\added{(first1 + $N$, first2 + $N$, result + $N$)}}.
...
type~(\ref{function.objects})}{a\oldtxt{n} callable object~(\cxxref{func.require})}. The return value of \changed{the
...
defaults to
\tcode{*i < *j != false}.}
\oldtxt{For algorithms other than those described in~\ref{alg.binary.search} to work correctly,
...
\techterm{strict}
refers to the
requirement of an irreflexive relation (\tcode{\changed{!comp(x, x)}{!\textit{INVOKE}(comp, x, x)}} for all \tcode{x}),
and the term
\techterm{weak}
...
\tcode{equiv(a, b)}
as
\tcode{\changed{!comp(a, b) \&\& !comp(b, a)}{!\textit{INVOKE}(comp, a, b) \&\& !\textit{INVOKE}(comp, b, a)}},
...
\begin{itemize}
\item
\tcode{\changed{comp(a, b) \&\& comp(b, c)}{\textit{INVOKE}(comp, a, b) \&\& \textit{INVOKE}(comp, b, c)}}
implies
\tcode{\changed{comp(a, c)}{\textit{INVOKE}(comp, a, c)}}
\item
...
\end{removedblock}
\begin{codeblock}
@\oldtxt{make_pair(}\newtxt{\{}@lower_bound(first, last, value, comp@\added{, proj}@),
           upper_bound(first, last, value, comp@\added{, proj}@)@\oldtxt{)}\newtxt{\}}@
\end{codeblock}
...
make_\newtxt{tagged_}tuple\newtxt{<tag::in1, tag::in2,}}}{\\}\tcode{\added{\newtxt{tag::out>}(last1, last2, result + (last1 - first1) + (last2 - first2))}}.
...
\pnum
\returns
\tcode{make_\newtxt{tagged_}tuple\newtxt{<tag::in1, tag::in2, tag::out>}(last1, last2, result + (last1 - first1) + (last2 - first2))}.
...
\tcode{\added{make_\newtxt{tagged_}tuple\newtxt{<tag::in1, tag::in2, tag::out>}(last1, last2, result + $n$)}}\added{, where \tcode{$n$} is
...
\pnum
\returns
\removed{The end of the constructed range}\tcode{\oldtxt{make_pair(}\newtxt{\{}\added{last1, result + $n$}\oldtxt{)}\newtxt{\}}, where $n$
...
\pnum
\returns
\tcode{\oldtxt{pair<const T\&, const T\&>(}\newtxt{\{}b, a\oldtxt{)}\newtxt{\}}} if \tcode{b} is smaller
than \tcode{a}, and
\tcode{\oldtxt{pair<const T\&, const T\&>(}\newtxt{\{}a, b\oldtxt{)}\newtxt{\}}} otherwise.

\pnum
\notes
Returns \tcode{\oldtxt{pair<const T\&, const T\&>(}\newtxt{\{}a, b\oldtxt{)}\newtxt{\}}} when the arguments are equivalent.
...
\pnum
\returns \tcode{\oldtxt{pair<T, T>(}\newtxt{\{}x, y\oldtxt{)}\newtxt{\}}}, where \tcode{x} has the smallest and \tcode{y} has the
...
template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Proj = identity,
    IndirectCallabl@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<IteratorType<Rng>, Proj>> Comp = less<>>
  IteratorType<Rng>
    min_element(Rng& rng, Comp comp = Comp{}, Proj proj = Proj{});
\end{itemdecl}
\end{addedblock}
...
\pnum
\returns
\tcode{\oldtxt{make_pair(}\newtxt{\{}first, first\oldtxt{)}\newtxt{\}}} if \range{first}{last} is empty, otherwise
\tcode{\oldtxt{make_pair(}\newtxt{\{}m, M\oldtxt{)}\newtxt{\}}}, where \tcode{m} is
