...
\begin{codeblock}
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Proj = identity,
    ...
    @\newtxt{tagged_}@pair<@\newtxt{tag::in(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>@\newtxt{)}@, @\newtxt{tag::fun(}@Fun@\newtxt{)}@>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, WeakInputIterator I2,
    ...
    @\newtxt{tagged_}@pair<@\newtxt{tag::in1(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng1>@\newtxt{)}@, @\newtxt{tag::in2(}@I2@\newtxt{)}@>
  ...
  template<Input@\oldtxt{Iterable}\newtxt{Range}@ Rng1, Input@\oldtxt{Iterable}\newtxt{Range}@ Rng2,
      ...
      IndirectCallablePredicate<Projected<IteratorType<Rng1>, Proj1>,
        Projected<IteratorType<Rng2>, Proj2>> Pred = equal_to<>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::in1(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng1>@\newtxt{)}@,
                @\newtxt{tag::in2(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng2>@\newtxt{)}@>
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng>
    requires Permutable<IteratorType<Rng>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::begin(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>@\newtxt{)}@,
                @\newtxt{tag::end(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>@\newtxt{)}@>
...
\begin{codeblock}
  ...
  template<Forward@\oldtxt{Iterable}\newtxt{Range}@ Rng, class Proj = identity,
      IndirectCallable@\oldtxt{Relation}\newtxt{StrictWeakOrder}@<Projected<IteratorType<Rng>, Proj>> Comp = less<>>
    @\newtxt{tagged_}@pair<@\newtxt{tag::min(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>@\newtxt{)}@, @\newtxt{tag::max(}\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>@\newtxt{)}@>
      minmax_element(Rng&@\newtxt{\&}@ rng, Comp comp = Comp{}, Proj proj = Proj{});
