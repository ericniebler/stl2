...
namespace std { @\newtxt{namespace experimental \{ namespace ranges_v1 \{}@
  ...
  template<ForwardRange Rng, class T, class Pred = equal_to<>,
      class Proj = identity>
    requires IndirectlyComparable<IteratorType<Rng@\oldtxt{1}@>, const T*, Pred, Proj>@\newtxt{()}@
    @\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>
  ...
  template<InputIterator I, Sentinel<I> S, @\newtxt{WeaklyIncrementable O, class F,}@ class Proj = identity@\oldtxt{,}\newtxt{>}@
    ...
    @\newtxt{requires Writable<O, IndirectCallableResultType<F, Projected<I, Proj>{}>{}>()}@
    tagged_pair<tag::in(I), tag::out(O)>
  ...
  template<InputRange Rng, @\newtxt{WeaklyIncrementable O, class F,}@ class Proj = identity@\oldtxt{,}\newtxt{>}@
    ...
    @\newtxt{requires Writable<O, IndirectCallableResultType<F, Projected<IteratorType<R>, Proj>{}>{}>()}@
    tagged_pair<tag::in(@\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>), tag::out(O)>
  ...
  template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2, @\newtxt{WeaklyIncrementable O,}@
    ...
    @\newtxt{requires Writable<O, IndirectCallableResultType<F, Projected<I1, Proj1>,}@
      @\newtxt{Projected<I2, Proj2>{}>{}>()}@
  ...
  template<InputRange Rng, WeakInputIterator I, @\newtxt{WeaklyIncrementable O, class F,}@
    ...
    @\newtxt{requires Writable<O, IndirectCallableResultType<F,}@
      @\newtxt{Projected<IteratorType<Rng>, Proj1>, Projected<I, Proj2>{}>{}>()}@
  ...
  template<InputRange Rng1, InputRange Rng2, @\newtxt{WeaklyIncrementable O, class F,}@
    ...
    @\newtxt{requires Writable<O, IndirectCallableResultType<F, Projected<IteratorType<Rng1>, Proj1>,}@
      @\newtxt{Projected<IteratorType<Rng2>, Proj2>{}>{}>()}@
    tagged_tuple<tag::in1(@\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng1>),
                 tag::in2(@\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng2>),
                 tag::out(O)>
      transform(Rng1&@\newtxt{\&}@ rng1, Rng2&@\newtxt{\&}@ rng2, O result,
  ...
  template<InputIterator I1, Sentinel<I@\newtxt{1}@> S1, RandomAccessIterator I2, Sentinel<I@\newtxt{2}@> S2,
    ...
    requires IndirectlyCopyable<I1, I2>@\newtxt{()}@ && Sortable<I2, Comp, Proj@\newtxt{2}@>@\newtxt{()}@ @\newtxt{\&\&}@
        @\newtxt{IndirectCallableStrictWeakOrder<Comp, Projected<I1, Proj1>, Projected<I2, Proj2>{}>()}@
    I2
  ...
  template<InputRange Rng1, RandomAccessRange Rng2, class @\oldtxt{R}\newtxt{Comp}@ = less<>,
    ...
    requires IndirectlyCopyable<IteratorType<Rng1>, IteratorType<Rng2>>@\newtxt{()}@ &&
        ...
        @\newtxt{IndirectCallableStrictWeakOrder<Comp, Projected<IteratorType<Rng1>, Proj1>,}@
          @\newtxt{Projected<IteratorType<Rng2>, Proj2>{}>()}@
    @\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng2>
  ...
  template<RandomAccessRange Rng, class Comp = less<>, class Proj = identity>
    requires Sortable<IteratorType<Rng>, Comp, Proj>@\newtxt{()}@
    @\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>
      nth_element(Rng&@\newtxt{\&}@ rng, IteratorType<Rng> nth, Comp comp@\newtxt{ = Comp\{\}}@, Proj proj = Proj{});
  ...
  template<class T, class @\newtxt{Proj = identity,}@
      @\newtxt{IndirectCallableStrictWeakOrder<Projected<const T*, Proj>{}> }@Comp@\newtxt{ = less<>}@>
...
\begin{codeblock}
  ...
  template<InputRange Rng, @\newtxt{class Proj = identity,}@
      IndirectCallableStrictWeakOrder<@\newtxt{Projected<}@IteratorType<Rng>@\newtxt{, Proj>}@> Comp@\newtxt{ = less<>}@>
