...
namespace std { @\newtxt{namespace experimental \{ namespace ranges\oldtxt{_v1} \{ inline namespace v1 \{}@
  ...
  @\oldtxt{template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,}@
      @\oldtxt{class Proj1 = identity, class Proj2 = identity,}@
      @\oldtxt{IndirectCallablePredicate<Projected<I1, Proj1>, Projected<I2, Proj2>{}> Pred = equal_to<>{}>}@
    @\oldtxt{tagged_pair<tag::in1(I1), tag::in2(I2)>}@
      @\oldtxt{mismatch(I1 first1, S1 last1, I2 first2, Pred pred = Pred\{\},}@
               @\oldtxt{Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@

  @\oldtxt{template<InputRange Rng1, WeakInputIterator I2,}@
      @\oldtxt{class Proj1 = identity, class Proj2 = identity,}@
      @\oldtxt{IndirectCallablePredicate<Projected<IteratorType<Rng1>, Proj1>,}@
        @\oldtxt{Projected<I2, Proj2>{}> Pred = equal_to<>{}>}@
    @\oldtxt{tagged_pair<tag::in1(IteratorType<Rng1>), tag::in2(I2)>}@
      @\oldtxt{mismatch(Rng1\& rng1, I2 first2, Pred pred = Pred\{\},}@
               @\oldtxt{Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@
  ...
  @\oldtxt{template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,}@
      @\oldtxt{class Pred = equal_to<>, class Proj1 = identity, class Proj2 = identity>}@
    @\oldtxt{requires IndirectlyComparable<I1, I2, Pred, Proj1, Proj2>}@
    @\oldtxt{bool equal(I1 first1, S1 last1,}@
               @\oldtxt{I2 first2, Pred pred = Pred\{\},}@
               @\oldtxt{Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@

  @\oldtxt{template<InputRange Rng1, WeakInputIterator I2, class Pred = equal_to<>,}@
      @\oldtxt{class Proj1 = identity, class Proj2 = identity>}@
    @\oldtxt{requires IndirectlyComparable<IteratorType<Rng1>, I2, Pred, Proj1, Proj2>}@
    @\oldtxt{bool equal(Rng1\&\& rng1, I2 first2, Pred pred = Pred\{\},}@
               @\oldtxt{Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@
  ...
  @\oldtxt{template<ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2,}@
      @\oldtxt{class Pred = equal_to<>, class Proj1 = identity, class Proj2 = identity>}@
    @\oldtxt{requires IndirectlyComparable<I1, I2, Pred, Proj1, Proj2>}@
    @\oldtxt{bool is_permutation(I1 first1, S1 last1, I2 first2,}@
                        @\oldtxt{Pred pred = Pred\{\},}@
                        @\oldtxt{Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@

  @\oldtxt{template<ForwardRange Rng1, ForwardIterator I2, class Pred = equal_to<>,}@
      @\oldtxt{class Proj1 = identity, class Proj2 = identity>}@
    @\oldtxt{requires IndirectlyComparable<IteratorType<Rng1>, I2, Pred, Proj1, Proj2>}@
    @\oldtxt{bool is_permutation(Rng1\&\& rng1, I2 first2, Pred pred = Pred\{\},}@
                        @\oldtxt{Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@
  ...
  // \ref{alg.swap}, swap:
  @\oldtxt{template<ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2>}@
    @\oldtxt{requires IndirectlySwappable<I1, I2>}@
    @\oldtxt{tagged_pair<tag::in1(I1), tag::in2(I2)>}@
      @\oldtxt{swap_ranges(I1 first1, S1 last1, I2 first2);}@

  @\oldtxt{template<ForwardRange Rng, ForwardIterator I>}@
    @\oldtxt{requires IndirectlySwappable<IteratorType<Rng>, I>}@
    @\oldtxt{tagged_pair<tag::in1(IteratorType<Rng>), tag::in2(I)>}@
      @\oldtxt{swap_ranges(Rng\& rng1, I first2);}@
  ...
  @\oldtxt{template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,}@
    ...
    @\oldtxt{tagged_tuple<tag::in1(I1), tag::in2(I2), tag::out(O)>}@
      @\oldtxt{transform(I1 first1, S1 last1, I2 first2, O result,}@
                @\oldtxt{F binary_op, Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@

  @\oldtxt{template<InputRange Rng, WeakInputIterator I,}@
      @\oldtxt{class Proj1 = identity, class Proj2 = identity,}@
    ...
    @\oldtxt{tagged_tuple<tag::in1(IteratorType<Rng>), tag::in2(I), tag::out(O)>}@
      @\oldtxt{transform(Rng\& rng1, I first2, O result,}@
                @\oldtxt{F binary_op, Proj1 proj1 = Proj1\{\}, Proj2 proj2 = Proj2\{\});}@
  ...
  template<Function F, OutputIterator<@\oldtxt{ResultType<F>}\newtxt{result_of_t<F\&()>}@> O,
      Sentinel<O> S>
    O generate(O first, S last, F gen);

  template<Function F, OutputRange<@\oldtxt{ResultType<F>}\newtxt{result_of_t<F\&()>}@> Rng>
    @\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>
      generate(Rng&@\newtxt{\&}@ rng, F gen);

  template<Function F, WeakOutputIterator<@\oldtxt{ResultType<F>}\newtxt{result_of_t<F\&()>}@> O>
...
\begin{addedblock}
\pnum
\oldtxt{For binary transforms that do not take \tcode{last2}, let \tcode{last2}
