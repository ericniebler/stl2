...
namespace std {
  ...
  template<InputRange Rng, class Proj = identity,
    ...
    tagged_pair<tag::in(IteratorType<Rng>), tag::fun(Fun)>
  ...
  template<InputRange Rng1, InputRange Rng2,
      ...
      IndirectCallablePredicate<Projected<IteratorType<Rng1>, Proj1>,
        Projected<IteratorType<Rng2>, Proj2>> Pred = equal_to<>>
    tagged_pair<tag::in1(IteratorType<Rng1>), tag::in2(IteratorType<Rng2>)>
  ...
  template<InputRange Rng, WeaklyIncrementable O>
    ...
    tagged_pair<tag::in(IteratorType<Rng>), tag::out(O)>
  ...
  template<BidirectionalRange Rng, BidirectionalIterator I>
    ...
    tagged_pair<tag::in1(IteratorType<Rng>), tag::in2(I)>
  ...
  template<InputRange Rng, WeakInputIterator I,
    ...
    tagged_tuple<tag::in1(IteratorType<Rng>), tag::in2(I), tag::out(O)>
  ...
  template<InputRange Rng1, InputRange Rng2,
    ...
    tagged_tuple<tag::in1(IteratorType<Rng1>), tag::in2(IteratorType<Rng2>), tag::out(O)>
  ...
  template<ForwardRange Rng>
    requires Permutable<IteratorType<Rng>>
    tagged_pair<tag::begin(IteratorType<Rng>), tag::end(IteratorType<Rng>)>
  ...
  template<InputRange Rng1, InputRange Rng2, WeaklyIncrementable O,
      class Comp = less<>, class Proj1 = identity, class Proj2 = identity>
    requires Mergeable<IteratorType<Rng1>, IteratorType<Rng2>, O, Comp, Proj1, Proj2>
    tagged_pair<tag::in1(IteratorType<Rng1>), tag::out(O)>
...
\begin{codeblock}
  ...
  template<ForwardRange Rng, class Proj = identity,
      IndirectCallableStrictWeakOrder<Projected<IteratorType<Rng>, Proj>> Comp = less<>>
    tagged_pair<tag::min(IteratorType<Rng>), tag::max(IteratorType<Rng>)>
