...
namespace std {
  ...
  \ednote{Is the out-of-order but short form of \tcode{all_of} better than
  the separate \tcode{requres} clause?}
  \begin{codeblock}
  ...
  template <InputIterator I, Sentinel<I> S, class Pred,
    ...
    requires InvokablePredicate<Pred, ResultType<CallableType<Proj>, ValueType<I>>>
    bool any_of(I first, S last, Pred pred, Proj proj = Proj{});

  template <InputIterator I, Sentinel<I> S, class Pred,
      Invokable<ValueType<I>> Proj = identity>
    requires InvokablePredicate<Pred,
      ResultType<CallableType<Proj>, ValueType<I>>>
  ...
  template<ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2,
      ...
      Invokable<ValueType<I>> Proj = identity>
    requires InvokableRelation<Pred, ValueType<I2>,
      ResultType<CallableType<Proj>, ValueType<I>>>
    I1
  ...
  template<ForwardIterator I, Sentinel<I> S,
     class BinaryPred = equal_to<>, Invokable<ValueType<I>> Proj = identity>
    requires Invokable<Proj, ValueType<I>> &&
  ...
  template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,
    ...
    requires InvokablePredicate<BinaryPred,
      ResultType<CallableType<Proj>1, ValueType<I1>>,
      ResultType<CallableType<Proj>2, ValueType<I2>>>
    pair<I1, I2>
  ...
  template<InputIterator I, Sentinel<I> S, WeakIterator O,
      class Pred, Invokable<ValueType<I>> Proj = identity>
    requires IndirectlyCopyable<I, O, Proj> &&
  ...
  template<InputIterator I, Sentinel<I> S, WeakIterator O,
    ...
    requires Invokable<UnaryOperation,
        ResultType<CallableType<Proj>, ValueType<I>>> &&
      Writable<O, ResultType<CallableType<UnaryOperation>,
        ResultType<CallableType<Proj>, ValueType<I>>>>
    pair<I, O>
      transform(I first, S last, O result,
                UnaryOperation op, Proj proj = Proj{});
\end{codeblock}
\ednote{Out-of-order parameters here as an experiment in reducing verbosity.}
\begin{codeblock}
    template<InputIterator I1, Sentinel<I1> S1, WeakInputIterator I2,
        Invokable<ValueType<I1>> Proj1 = identity,
        Invokable<ValueType<I2>> Proj2 = identity,
  ...
  template<InputIterator I1, Sentinel<I1> S1,
    ...
    requires Invokable<BinaryOperation,
        ResultType<CallableType<Proj1>, ValueType<I1>>,
        ResultType<CallableType<Proj2>, ValueType<I2>>> &&
      Writable<O, ResultType<
        CallableType<BinaryOperation>,
        ResultType<CallableType<Proj1>, ValueType<I1>>,
        ResultType<CallableType<Proj2>, ValueType<I2>>>>>
    tuple<I1, I2, O>
  ...
  template<ForwardIterator I, Sentinel<I> S, class T1, Semiregular T2,
      Invokable<ValueType<I>> Proj = identity>
  ...
  template<ForwardIterator I, Sentinel<I> S, class Pred, Semiregular T,
      Invokable<ValueType<I>> Proj = identity>
  ...
  template<InputIterator I, Sentinel<I> S, WeakIterator O, class T1,
      Semiregular T2, Invokable<ValueType<I>> Proj = identity>
  ...
  \end{codeblock}
  \ednote{Why does the Palo Alto TR require that R is Semiregular?}
  \begin{codeblock}

  template<ForwardIterator I, Sentinel<I> S, Invokable<ValueType<I>> Proj = identity,
      Relation<ResultType<CallableType<Proj>, ValueType<I>>> R = equal_to<>>
  ...
  template<InputIterator I, Sentinel<I> S, WeakOutputIterator<ValueType<I>> O1,
      WeakOutputIterator<ValueType<I>> O2, Invokable<ValueType<I>> Proj = identity,
      InvokablePredicate<ResultType<CallableType<Proj>, ValueType<I>>> Pred>
    tuple<I, O1, O2>
  ...
  template<ForwardIterator I, Sentinel<I> S, Invokable<ValueType<I>> Proj = identity,
      Relation<ResultType<CallableType<Proj>, ValueType<I>>> Comp = less<>>
  ...
  template<RandomAccessIterator I, Sentinel<I> S, Semiregular Comp = less<>,
      Invokable<ValueType<I>> Proj = identity>
    requires Sortable<I, Comp, Proj>
    void nth_element(I first, I nth, S last, Comp comp, Proj proj = Proj{});

  // \ref{alg.binary.search}, binary search:
  template<ForwardIterator I, Sentinel<I> S, TotallyOrdered T,
      Invokable<ValueType<I>> Proj = identity,
      Relation<T, ResultType<CallableType<Proj>, ValueType<I>>> Comp = less<>>
    I
