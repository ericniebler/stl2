...
namespace std { @\newtxt{namespace experimental \{ namespace ranges_v1 \{}@
  ...
  template<RandomAccessRange Rng, class Comp = less<>, class Proj = identity>
    requires Sortable<@\oldtxt{IteratorType}\newtxt{iterator_t}@<Rng>, Comp, Proj>@\newtxt{()}@
    @\oldtxt{IteratorType}\newtxt{safe_iterator_t}@<Rng>
      nth_element(Rng&@\newtxt{\&}@ rng, @\oldtxt{IteratorType}\newtxt{iterator_t}@<Rng> nth, Comp comp, Proj proj = Proj{});
  ...
  template<class T, class Comp@\newtxt{ = less<>}@>
    requires StrictWeakOrder<@\oldtxt{FunctionType}\newtxt{as_function_t}@<Comp>, T>@\newtxt{()}@
...
\begin{codeblock}
  ...
  template<@\oldtxt{Semiregular}\newtxt{Copyable}@ T, class Comp@\newtxt{ = less<>}@>
    requires StrictWeakOrder<@\oldtxt{FunctionType}\newtxt{as_function_t}@<Comp>, T>@\newtxt{()}@
    constexpr T min(initializer_list<T> t, Comp comp@\newtxt{ = Comp\{\}}@);

  template<InputRange Rng,
      IndirectCallableStrictWeakOrder<@\oldtxt{IteratorType}\newtxt{iterator_t}@<Rng>> Comp@\newtxt{ = less<>}@>
