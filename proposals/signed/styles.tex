...
\makeevenhead{cpppage}{Proposal for \Cpp replacing unsigned integer types with signed integers in the Standard Library}{}{\textbf{\docno}}
\makeoddhead{cpppage}{Proposal for \Cpp replacing unsigned integer types with signed integers in the Standard Library}{}{\textbf{\docno}}
