...
\usepackage[pdftex,
            pdftitle={Proposal for C++ adding specialized memory functions to the Ranges library},
            pdfsubject={Proposal for C++ adding specialized memory functions to the Ranges library},
            pdfcreator={Christopher Di Bella},
            bookmarks=true,
...
\input{../../tables}
\input{../../cxx}
\cxxsec{container.requirements.general}{23.2.1}
...
\title{\Huge
Proposal for \Cpp replacing unsigned integer types with signed integers in the Standard Library}
