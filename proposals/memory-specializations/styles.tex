...
\makeevenhead{cpppage}{Proposal for \Cpp adding specialized memory functions to the Ranges library}{}{\textbf{\docno}}
\makeoddhead{cpppage}{Proposal for \Cpp adding specialized memory functions to the Ranges library}{}{\textbf{\docno}}
