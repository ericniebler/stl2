...
\begin{codeblock}
template <class I>
concept bool @\xname{InputReference}@() { // \expos
...
template <class T>
concept boo @\xname{NoThrowForwardIterator}@ { // \expos
...
\begin{itemize}
\item This section defines an expositional concept, \tcode{\xname{NoThrowForwardIterator}}, which requires all
...
\enternote
The distinction between \tcode{ForwardIterator} and \tcode{\xname{NoThrowForwardIterator}} is purely semantic.
\exitnote
\end{itemize}
} %% \color{addclr}
