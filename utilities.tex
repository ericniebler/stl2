...
overloads of \tcode{swap} in namespace \tcode{std::experimental::ranges\oldtxt{_v1}}. The precise mechanism by which
...
@\added{namespace std \{}@
  ...
  template<class T>
    @\added{requires experimental::ranges\oldtxt{_v1}::Movable<T>()}@
...
@\added{namespace std \{ namespace experimental \{ namespace ranges\oldtxt{_v1}\newtxt{ \{ inline namespace v1} \{}@
  ...
  template <class T = void>
    @\added{requires \added{Strict}TotallyOrdered<T>() || Same<T, void>()}@
  struct greater;
...
template <> struct greater<void> {
  template <class T, class U>
    @\added{requires \added{Strict}TotallyOrdered<T, U>()}@
  constexpr auto operator()(T&& t, U&& u) const
    -> decltype(std::forward<T>(t) > std::forward<U>(u));
