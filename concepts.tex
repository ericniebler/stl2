...
\begin{itemdescr}
\pnum
Let \tcode{C} be \tcode{common_type_t<T, U>}. Let \tcode{t1} and \tcode{t2} be objects
...
type, let \tcode{v} be a lvalue of type \tcode{R};
...
\tcode{common_type_t<T, U>}. Then \tcode{EqualityComparable<T, U>()}
is satisfied if and only if:
...
of type \tcode{U}, and \tcode{C} be \tcode{common_type_t<T, U>}.
...
object of type \tcode{U}, and \tcode{C} be \tcode{common_type_t<T, U>}.
