...
\tcode{C}, \tcode{T} and \tcode{U} share a \techterm{common type},
...
\begin{itemize}
\item The expression \tcode{t = rv} is an lvalue of type (non-const) \tcode{T}, the expression returns
...
\begin{itemize}
\item The expression \tcode{t = v} is an lvalue of type (non-\tcode{const}) \tcode{T},
the expression returns a reference to \tcode{t}, \tcode{v} is unchanged, and after the
