...
\rSec2[concepts.lib.callable]{Concept Callable}
...
\rSec2[concepts.lib.regularcallable]{Concept RegularCallable}
...
\rSec2[concepts.lib.callablepredicate]{Concept CallablePredicate}
...
\rSec2[concepts.lib.callablerelation]{Concept CallableRelation}
...
concept bool CallableRelation() {
  return CallablePredicate<F, T, T> &&
    Relation<FunctionType<R>, T>();
}

template <class F, class T, class U>
concept bool CallableRelation() {
  return Relation<FunctionType<R>, T, U>();
}
\end{itemdecl}
