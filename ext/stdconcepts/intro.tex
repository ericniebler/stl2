...
prepend the prefix "Cpp98" to uses of the names below in the Standard Library
clauses, and change them to \textit{italic} non code font (for example, \textit{Cpp98Destructible}):}
\begin{itemize}
