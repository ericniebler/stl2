...
\item Portions of the utilities library which do not break existing code: the
  \tcode{std2::swap} customization point which supports the \tcode{Swappable}
  concept, the \tcode{identity} function object, changes to \tcode{common_type}
  and the addition of the \tcode{common_reference} type trait
