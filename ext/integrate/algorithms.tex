...
\pnum
Overloads of algorithms that take \tcode{Range} arguments~(\ref{range.range})
...
\textit{Cpp98MoveConstructible} requirements (\tref{moveconstructible}).
\begin{note} \tcode{Function} need not meet the requirements of
\textit{Cpp98CopyConstructible} (\tref{copyconstructible}). \end{note}
...
\textit{Cpp98MoveAssignable} requirements (\tref{moveassignable}).
...
then \tcode{T} shall be \textit{Cpp98CopyAssignable} (\tref{copyassignable}).
Otherwise, \tcode{T} shall be both
\textit{Cpp98CopyConstructible} (\tref{copyconstructible}) and \textit{Cpp98CopyAssignable}.
\begin{note}
For the overloads with an \tcode{ExecutionPolicy}, there may be a performance
...
the \textit{Cpp98MoveConstructible} (\tref{moveconstructible}) and
\textit{Cpp98MoveAssignable} (\tref{moveassignable}) requirements.
...
specification of strict weak ordering in \ref{concepts}.}
...
\textit{Cpp98MoveConstructible} (\tref{moveconstructible}) and
\textit{Cpp98MoveAssignable} (\tref{moveassignable}) requirements.
...
value type shall be \textit{Cpp98CopyAssignable} (\tref{copyassignable}),
