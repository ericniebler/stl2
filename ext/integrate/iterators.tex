...
namespace std {
  ...
  template <class, class... Is> struct indirect_result@\added{ \{ \}}@;
  ...
  template <class F, class... Is>
  using indirect_result_t = typename indirect_result<F>::type;
  ...
  @\ednote{ranges::iterator_traits from P0896R1 is intentionally omited.}@
...
@\added{namespace std\{}@
  ...
  @\removed{template <class, class...> struct indirect_result \{ \};}@
...
\pnum
\enternote The \tcode{@\added{ranges::}@equal_to<>} and \tcode{@\added{ranges::}@less<>}~(\ref{range.comparisons}) function types used in the
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr void advance(I& i, S bound) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr @\added{iter_}@difference@\removed{_type}@_t<I> advance(I& i, @\added{iter_}@difference@\removed{_type}@_t<I> n, S bound) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr @\added{iter_}@difference@\removed{_type}@_t<I> distance(I first, S last) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Range R>
  constexpr @\added{iter_}@difference@\removed{_type}@_t<iterator_t<R>> distance(R&& r) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I>
  constexpr I next(I x, @\added{iter_}@difference@\removed{_type}@_t<I> n) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr I next(I x, @\added{iter_}@difference@\removed{_type}@_t<I> n, S bound) const;
\end{itemdecl}
...
\begin{itemdecl}
template <BidirectionalIterator I>
  constexpr I prev(I x, @\added{iter_}@difference@\removed{_type}@_t<I> n) const;
\end{itemdecl}
...
\begin{itemdecl}
template <BidirectionalIterator I>
  constexpr I prev(I x, @\added{iter_}@difference@\removed{_type}@_t<I> n, I bound) const;
\end{itemdecl}
