...
\ednote{Relocate [range.iterator.assoc.types] from P0896R1 here.}

\rSec2[iterator.assoc.types]{Iterator associated types}
\ednote{Relocated from [range.iterator.assoc.types] in P0896R1 and changed as
follows:}
...
through \tcode{RandomAccessIterator} from subsection [range.iterator.requirements]
