...
namespace std {
  ...
  @\added{template <ranges::InputIterator I, class S>}@
    @\added{struct iterator_traits<ranges::common_iterator<I, S>{>};}@

  @\added{template <ranges::ForwardIterator I, class S>}@
    @\added{struct iterator_traits<ranges::common_iterator<I, S>{>};}@

  @\added{template <ranges::InputIterator I>}@
    @\added{struct iterator_traits<ranges::counted_iterator<I>{>};}@
  // ... as before
}
\end{codeblock}
...
\ednote{This section is relocated from REF TODO in the Ranges TS.}
...
@\added{namespace std \{ namespace ranges \{}@
  template <Readable I, IndirectRegularUnaryInvocable<I> Proj>
  struct projected {
    using value_type = remove_cv@\added{ref}@_t<@\removed{remove_reference_t<}@indirect_result_of_t<Proj&(I)>@\removed{>}@>;
...
capable of representing a non-\changed{bounded}{common} range of elements (where the types of the
iterator and sentinel differ) as a \changed{bounded}{common} range (where they are the same). It
...
namespace std { namespace ranges {
  ...
  @\removed{template <InputIterator I, class S>}@
  @\removed{struct iterator_category<common_iterator<I, S>> \{}@
    @\removed{using type = input_iterator_tag;}@
  @\removed{\};}@

  @\removed{template <ForwardIterator I, class S>}@
  @\removed{struct iterator_category<common_iterator<I, S>> \{}@
    @\removed{using type = forward_iterator_tag;}@
  @\removed{\};}@
...
is an lvalue of type \tcode{const ranges::common_iterator<I, S>}, then
...
namespace std { namespace ranges {
  ...
  @\removed{template <InputIterator I>}@
  @\removed{struct iterator_category<counted_iterator<I>{>} \{}@
