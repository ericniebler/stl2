...
\pnum
Clause~\ref{std2.requirements}\changed{,}{ and} Clauses~\ref{\firstlibchapter}
...
Clauses~\ref{\firstlibchapter} through~\ref{\lastlibchapter}\removed{ and
...
\tcode{<\changed{experimental/ranges}{std2}/functional>} & \tcode{<\changed{experimental/ranges}{std2}/type_traits>} \\
