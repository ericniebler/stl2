...
\end{codeblock}\begin{addedblock}\begin{codeblock}
  ...
  @\newtxt{template<class I, class S>}@
    @\newtxt{struct incrementable_traits<common_iterator<I, S>>;}@
  ...
  @\newtxt{template<class I>}@
    @\newtxt{struct incrementable_traits<counted_iterator<I>>;}@
...
\oldtxt{Let \tcode{n} be the smallest value
...
namespace std {
  ...
  class common_iterator {
  public:
    @\oldtxt{using difference_type = iter_difference_t<I>;}@
...
keeps track of \oldtxt{its distance from its starting position}
\newtxt{the distance to the end of its range}. It can be
...
\pnum
Two values \tcode{i1} and \tcode{i2} of \oldtxt{(possibly differing)} types
...
namespace std {
  ...
  public:
    ...
    constexpr counted_iterator operator+(@\newtxt{iter_}@difference_t@\oldtxt{ype}\newtxt{<I>}@ n) const
  ...
  private:
    I current @\newtxt{= I()}@;                 // \expos
    iter_difference_t<I> @\oldtxt{cnt}\newtxt{length = 0}@; // \expos
  };
...
\tcode{\oldtxt{cnt}\newtxt{length}} with \tcode{x.\oldtxt{cnt}\newtxt{length}}.
\end{itemdescr}
...
\tcode{x.\oldtxt{cnt}\newtxt{length}} to \tcode{\oldtxt{cnt}\newtxt{length}}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to: \tcode{return \oldtxt{cnt}\newtxt{length};}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\oldtxt{\expects \tcode{n <= cnt}.}

\pnum
\effects Equivalent to: \tcode{return counted_iterator(current + n, \oldtxt{cnt}\newtxt{length} - n);}
\end{itemdescr}
...
\pnum
\effects Equivalent to: \tcode{return y.\oldtxt{cnt}\newtxt{length} - x.\oldtxt{cnt}\newtxt{length};}
\end{itemdescr}
...
\pnum
\effects Equivalent to: \tcode{return x.\oldtxt{cnt}\newtxt{length} == y.\oldtxt{cnt}\newtxt{length};}
\end{itemdescr}
...
because \tcode{\oldtxt{cnt}\newtxt{length}} counts down, not up.
\end{note}
\end{itemdescr}
...
Class \tcode{unreachable} \oldtxt{is a placeholder type that} can be
used with any \libconcept{WeaklyIncrementable} type to
denote the ``upper bound'' of an open interval.
\oldtxt{Comparing anything for equality with an object of type
