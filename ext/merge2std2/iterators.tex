...
\effects
Equivalent to:
\tcode{return distance(\changed{ranges}{::std2}::begin(r), \changed{ranges}{::std2}::end(r));}~(\ref{range.access})
...
\pnum
\effects
Equivalent to: \tcode{return \changed{ranges}{::std2}::size(r);}~(\ref{range.primitives.size})
