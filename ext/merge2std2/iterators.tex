...
\begin{codeblock}
  ...
  struct projected {
    using value_type = remove_cv_t<remove_reference_t<indirect_result@\oldtxt{_of}@_t<Proj&@\oldtxt{(}\newtxt{, }@I@\oldtxt{)}@>>>;
...
\begin{itemdecl}
template <Iterator I>
  constexpr void @\oldtxt{operator()}\newtxt{advance}@(I& i, difference_type_t<I> n) const;
\end{itemdecl}
...
template <Iterator I, Sentinel<I> S>
  constexpr void @\oldtxt{operator()}\newtxt{advance}@(I& i, S bound) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr difference_type_t<I> @\oldtxt{operator()}\newtxt{advance}@(I& i, difference_type_t<I> n, S bound) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr difference_type_t<I> @\oldtxt{operator()}\newtxt{distance}@(I first, S last) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Range R>
  constexpr difference_type_t<iterator_t<R>> @\oldtxt{operator()}\newtxt{distance}@(R&& r) const;
\end{itemdecl}

\begin{itemdescr}
\effects
Equivalent to:
\tcode{return distance(ranges::begin(r), ranges::end(r));}~(\ref{range.access})

\remarks
\oldtxt{Instantiations of this member function template may be ill-formed if the
...
\begin{itemdecl}
template <Iterator I>
  constexpr I @\oldtxt{operator()}\newtxt{next}@(I x, difference_type_t<I> n) const;
\end{itemdecl}
...
\begin{itemdecl}
template <Iterator I, Sentinel<I> S>
  constexpr I @\oldtxt{operator()}\newtxt{next}@(I x, difference_type_t<I> n, S bound) const;
\end{itemdecl}
...
\begin{itemdecl}
template <BidirectionalIterator I>
  constexpr I @\oldtxt{operator()}\newtxt{prev}@(I x, difference_type_t<I> n) const;
\end{itemdecl}
...
\begin{itemdecl}
template <BidirectionalIterator I>
  constexpr I @\oldtxt{operator()}\newtxt{prev}@(I x, difference_type_t<I> n, I bound) const;
\end{itemdecl}
