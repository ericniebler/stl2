...
\pnum
\effects
Value-initializes \tcode{current} and \tcode{\oldtxt{cnt}\newtxt{length}}.
...
\pnum
\effects
Initializes \tcode{current} with \tcode{i} and \tcode{\oldtxt{cnt}\newtxt{length}} with \tcode{n}.
\end{itemdescr}
...
\pnum
\effects
Assigns \tcode{x.current} to \tcode{current} and \tcode{x.\oldtxt{cnt}\newtxt{length}} to \tcode{\oldtxt{cnt}\newtxt{length}}.
\end{itemdescr}
