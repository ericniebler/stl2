...
is a container \oldoldtxt{that supports random access iterators\iref{random.access.iterators}
...
\oldoldtxt{are random access iterators\iref{random.access.iterators},
