  ...
  namespace ranges {
    ...
    template <InputIterator I, Sentinel<I> S, class Proj = identity,
      ...
      tagged_pair<tag::in(I), tag::fun(Fun)>
        @\newtxt{constexpr}@ for_each(I first, S last, Fun f, Proj proj = Proj{});

    template <InputRange Rng, class Proj = identity,
        IndirectUnaryInvocable<projected<iterator_t<Rng>, Proj>> Fun>
      tagged_pair<tag::in(safe_iterator_t<Rng>), tag::fun(Fun)>
        @\newtxt{constexpr}@ for_each(Rng&& rng, Fun f, Proj proj = Proj{});
    ...
    template <ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2,
      ...
      @\newtxt{constexpr}@ I1 find_end(I1 first1, S1 last1, I2 first2, S2 last2,
    ...
    template <InputRange Rng1, InputRange Rng2,
        ...
        IndirectRelation<projected<iterator_t<Rng1>, Proj1>,
          projected<iterator_t<Rng2>, Proj2>> Pred = equal_to<>>
      @\newtxt{constexpr}@ tagged_pair<tag::in1(safe_iterator_t<Rng1>),
    ...
    template <ForwardIterator I1, Sentinel<I1> S1, ForwardIterator I2,
        ...
        class Proj1 = identity, class Proj2 = identity>
      requires IndirectlyComparable<I1, I2, Pred, Proj1, Proj2>
      @\newtxt{constexpr}@ I1 search(I1 first1, S1 last1, I2 first2, S2 last2,
                          Pred pred = Pred{},
                          Proj1 proj1 = Proj1{}, Proj2 proj2 = Proj2{});
    ...
    template <ForwardIterator I, Sentinel<I> S, class T,
      ...
      @\newtxt{constexpr}@ I search_n(I first, S last, difference_type_t<I> count,
    ...
    template <class T, OutputRange<const T&> Rng>
      safe_iterator_t<Rng>
        @\newtxt{constexpr}@ fill(Rng&& rng, const T& value);
    ...
    template <BidirectionalIterator I, Sentinel<I> S, WeaklyIncrementable O>
      requires IndirectlyCopyable<I, O>
      @\newtxt{constexpr}@ tagged_pair<tag::in(I), tag::out(O)> reverse_copy(I first, S last, O result);
