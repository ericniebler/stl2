...
of a constant \removed{random access iterator}
\added{\oldconcept{RandomAccessIterator}}\iref{random.access.iterators} and
\removed{of a contiguous iterator\iref{iterator.concept.contiguous}}
\added{models \libconcept{ContiguousIterator}\iref{iterator.concept.contiguous},}
