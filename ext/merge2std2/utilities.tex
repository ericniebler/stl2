...
\begin{codeblock}
  ...
  constexpr @\oldtxt{\seebelow}\newtxt{auto}@ make_tagged_pair(T1&& x, T2&& y);
...
namespace std {
  ...
  template <TagSpecifier... Tags, class... Types>
    requires sizeof...(Tags) == sizeof...(Types)
      constexpr @\oldtxt{\seebelow}\newtxt{auto}@ make_tagged_tuple(Types&&... t);
  @\oldtxt{\}\}\}}@
}
\end{codeblock}
...
\oldtxt{Then the return type is \tcode{tagged<P, Tag1, Tag2>}.}

\pnum
\oldtxt{\returns \tcode{\{std::forward<T1>(x), std::forward<T2>(y)\}}.}

\pnum
\newtxt{\effects Equivalent to:}
\begin{codeblock}
@\newtxt{return tagged<P, Tag1, Tag2>\{std::forward<T1>(x), std::forward<T2>(y)\};}@
\end{codeblock}
...
\oldtxt{Then the return type is \tcode{tagged<\brk{}T, Tags...>}.}

\pnum
\oldtxt{\returns}\newtxt{\effects Equivalent to: \tcode{return}} \tcode{tagged<T, Tags...>(std::forward<Types>(t)...)\newtxt{;}}\oldtxt{.}
