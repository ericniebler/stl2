...
\begin{itemdescr}
\pnum
No exceptions are thrown from \newtxt{copy construction, move construction,
copy assignment, \newtxt{move assignment}, or} comparisons between
\oldtxt{objects} \newtxt{valid values} of type \tcode{I} and \tcode{S}.
...
\begin{itemdescr}
\pnum No exceptions are thrown from calls to \tcode{\newtxt{ranges::}begin} and
\tcode{\newtxt{ranges::}end} on an object of type \tcode{R}.
\end{itemdescr}
