...
\begin{itemdescr}
\pnum
\effects Calls \tcode{ranges::swap} on the result of applying \tcode{static_cast} to \tcode{*this} and
\tcode{that}.

\pnum
\throws Nothing unless the call to \tcode{ranges::swap} on the \tcode{Base} sub-objects throws.
