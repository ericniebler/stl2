...
\added{with respect to \tcode{comp}, and \tcode{proj} if present}.
...
\range{first}{last}
\added{as sorted with respect to \tcode{comp}, and \tcode{proj} if present,}
into the range
\range{first}{middle}.
...
range \range{first}{i} is sorted \added{with respect to \tcode{comp}, and \tcode{proj} if present}.
...
sorted \added{with respect to \tcode{comp}, and \tcode{proj} if present},
...
\range{first}{last}.
The resulting range
\added{is sorted with respect to \tcode{comp}, and \tcode{proj} if present.}
