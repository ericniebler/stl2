...
Let $E$ be
\begin{itemize}
\item \tcode{bool(*i == old_value)} for the \tcode{std::replace},
\item \tcode{bool(pred(*i))} for \tcode{std::replace_if},
...
\item \tcode{bool(*(first + (i - result)) == old_value)}
  for \tcode{std::replace_copy},
\item \tcode{bool(pred(*(first + (i - result))))}
  for \tcode{std::replace_copy_if},
...
Let $E$ be
\begin{itemize}
\item \tcode{bool(*i == value)} for \tcode{std::remove},
\item \tcode{bool(pred(*i))} for \tcode{std::remove_if},
...
Let $E$ be
\begin{itemize}
\item \tcode{bool(*i == value)} for \tcode{std::remove_copy},
\item \tcode{bool(pred(*i))} for \tcode{std::remove_copy_if},
