...
\end{codeblock}\begin{addedblock}\begin{codeblock}
  namespace ranges {
    ...
    template<ForwardRange R, class Proj = identity,
      ...
      constexpr safe_iterator_t<R>
        adjacent_find(R&& r, Pred pred = Pred{}, Proj proj = {});
  }
\end{codeblock}\end{addedblock}\begin{codeblock}
    ...
    template<ForwardIterator I, Sentinel<I> S, class T,
      ...
      constexpr subrange<I>
        search_n(I first, S last, iter_difference_t<I> count,
                 const T& value, Pred pred = Pred{}, Proj proj = {});
...
\end{codeblock}\begin{addedblock}\begin{codeblock}
  namespace ranges {
    template<Permutable I, Sentinel<I> S, class Proj = identity,
      ...
      constexpr I unique(I first, S last, C comp = C{}, Proj proj = {});
    template<ForwardRange R, class Proj = identity,
        IndirectRelation<projected<iterator_t<R>, Proj>> C = ranges::equal_to<>>
      requires Permutable<iterator_t<R>>
      constexpr safe_iterator_t<R>
        unique(R&& r, C comp = C{}, Proj proj = {});
  }
\end{codeblock}\end{addedblock}\begin{codeblock}
  template<class InputIterator, class OutputIterator>
    constexpr OutputIterator
  ...
  namespace ranges {
    ...
    template<InputIterator I, Sentinel<I> S, WeaklyIncrementable O,
      ...
      constexpr unique_copy_result<I, O>
        unique_copy(I first, S last, O result, C comp = C{}, Proj proj = {});
    template<InputRange R, WeaklyIncrementable O, class Proj = identity,
        IndirectRelation<projected<iterator_t<R>, Proj>> C = ranges::equal_to<>>
      requires IndirectlyCopyable<iterator_t<R>, O> &&
      ...
      constexpr unique_copy_result<safe_iterator_t<R>, O>
        unique_copy(R&& r, O result, C comp = C{}, Proj proj = {});
  }
\end{codeblock}\end{addedblock}\begin{codeblock}
    ...
    template<InputIterator I1, Sentinel<I1> S1, RandomAccessIterator I2, Sentinel<I2> S2,
      ...
      constexpr I2
        partial_sort_copy(I1 first, S1 last, I2 result_first, S2 result_last,
                          Comp comp = {}, Proj1 proj1 = Proj1{}, Proj2 proj2 = Proj2{});
...
implied or explicit comparison function \added{and any projection}.
...
\begin{addedblock}
\pnum
Let \tcode{comp} be \tcode{less\{\}} for the overload with no parameter
named \tcode{comp}.
\end{addedblock}
...
sorted with respect to \removed{\tcode{operator<} or} \tcode{comp} \added{and any projection}.
\added{For the overloads in namespace \tcode{std},}
\tcode{BidirectionalIterator} shall \changed{satisfy}{meet} the
\oldconcept{ValueSwappable} requirements\cxxiref{swappable.requirements}\removed{.
...
\range{first}{last}.
The resulting range
\added{is sorted with respect to \tcode{comp} and any projection.}
...
\pnum
\begin{example}
\added{Let \tcode{comp} be \tcode{less\{\}} for the overloads with
...
\tcode{operator<}
or \tcode{comp} \added{and any projection}.
