...
\pnum
\remarks
\added{Stable\cxxiref{algorithm.stable}.}
If
\range{first1}{last1}
contains $m$
...
elements from
\range{first1}{last1}
\changed{shall be}{are} copied to the output range\added{, in order}.
\end{itemdescr}
...
\added{In either case, the elements are copied in order.}
\end{itemdescr}
