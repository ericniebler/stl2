...
algorithmic operations on containers (\changed{C}{Subc}lause~\cxxref{containers}) and other sequences.
...
\pnum
\removed{To ease transition, implementations provide additional algorithm signatures that
...
namespace @\changed{std \{ namespace experimental \{ namespace ranges}{std2}@ { inline namespace v1 {
  ...
  template <RandomAccessIterator I, Sentinel<I> S, class Gen>
    requires Permutable<I> &&
      UniformRandom@\changed{Number}{Bit}@Generator<remove_reference_t<Gen>> &&
...
\pnum
All the operations in~\ref{std2.alg.sorting} take an optional binary callable
