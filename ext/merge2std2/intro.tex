...
P0XXX, a paper which proposes importing the definitions of the Ranges TS's Concepts
library (Clause 7) into \tcode{namespace std}.
...
\rSec1[intro]{General Principles}

\rSec2[intro.goals]{Goals}
...
\rSec2[intro.rationale]{Rationale}
...
to without this important Standard Library advance from users.
...
object~(\tsref{func.identity}) for namespace \tcode{std}.
