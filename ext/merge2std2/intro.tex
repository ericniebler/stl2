...
\item Clarify the specification of \tcode{tagged::swap}.

\item Return \tcode{auto} instead of \tcode{\seebelow} from \tcode{make_tagged_XXX}.
  Don't require implicit construction in the return of \tcode{make_tagged_pair}.
...
\item Require semantics for the \tcode{Constructible} requirements of
