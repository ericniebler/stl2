...
\item \ref{range.range} Much rephrasing for clarity.
  ...
  \tcode{\placeholder{forwarding-range}} is missing the most important semantic requirement! It also needs some explication.
...
\item \ref{range.view_interface} Apply post-completion requirements to the
  template parameter.
