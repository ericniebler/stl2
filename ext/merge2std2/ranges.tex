...
namespace std@\newtxt{::ranges}@ {
  ...
  // \ref{range.common}, \oldtxt{OutputRange} \newtxt{common range refinements}
  ...
  @\oldtxt{// \ref{range.common}, CommonRange}@
  template<class T>
...
namespace std::ranges {
  ...
  public:
    ...
    constexpr @\oldtxt{iterator}\newtxt{auto}@ end() @\oldtxt{requires CommonRange<R>;}\newtxt{\{}@
      @\newtxt{if constexpr (CommonRange<R>)}@
...
\rSec3[range.filter.iterator]{Class template \tcode{filter_view::iterator}}
...
namespace std::ranges {
  ...
  private:
    iterator_t<R> current_ @\oldtxt{\{\}} \newtxt{= iterator_t<R>()}@;           // \expos
...
namespace std::ranges {
  ...
  private:
    sentinel_t<R> end_ @\oldtxt{\{\}} \newtxt{= sentinel_t<R>()}@; // \expos
  public:
    sentinel() = default;
...
\rSec2[range.transform]{Class template \tcode{transform_view}}
...
\rSec3[range.transform.ops]{\tcode{transform_view} operations}
\rSec4[range.transform.ctor]{\tcode{transform_view} constructors}
...
\rSec4[range.transform.conv]{\tcode{transform_view} conversion}
...
\rSec4[range.transform.begin]{\tcode{transform_view} range begin}
...
\rSec4[range.transform.end]{\tcode{transform_view} range end}
...
\rSec4[range.transform.size]{\tcode{transform_view} range size}
...
\rSec4[range.transform.iterator.ops]{\tcode{transform_view::iterator} operations}
\rSec5[range.transform.iterator.ctor]{\tcode{transform_view::iterator} constructors}
...
\rSec5[range.transform.iterator.conv]{\tcode{transform_view::iterator} conversion}
...
\rSec5[range.transform.iterator.star]{\tcode{transform_view::iterator::operator*}}
...
\rSec5[range.transform.iterator.inc]{\tcode{transform_view::iterator::operator++}}
...
\rSec5[range.transform.iterator.dec]{\tcode{transform_view::iterator::operator\dcr}}
...
\rSec5[range.transform.iterator.adv]{\tcode{transform_view::iterator} advance}
...
\rSec5[range.transform.iterator.idx]{\tcode{transform_view::iterator} index}
...
\rSec4[range.transform.iterator.comp]{\tcode{transform_view::iterator} comparisons}
...
\rSec4[range.transform.iterator.nonmember]{\tcode{transform_view::iterator} non-member functions}
...
\rSec3[range.transform.sentinel.ctor]{\tcode{transform_view::sentinel constructors}}
...
\rSec3[range.transform.sentinel.conv]{\tcode{transform_view::sentinel conversion}}
...
\rSec3[range.transform.sentinel.comp]{\tcode{transform_view::sentinel comparison}}
...
\rSec3[range.transform.sentinel.nonmember]{\tcode{transform_view::sentinel} non-member functions}
...
\rSec2[range.iota]{Class template \tcode{iota_view}}
...
\rSec3[range.iota.ops]{\tcode{iota_view} operations}
\rSec4[range.iota.ctor]{\tcode{iota_view} constructors}
...
\rSec4[range.iota.begin]{\tcode{iota_view} range begin}
...
\rSec4[range.iota.end]{\tcode{iota_view} range end}
...
\rSec4[range.iota.size]{\tcode{iota_view} range size}
...
\rSec4[range.iota.iterator.ops]{\tcode{iota_view::iterator} operations}
\rSec5[range.iota.iterator.ctor]{\tcode{iota_view::iterator} constructors}
...
\rSec5[range.iota.iterator.star]{\tcode{iota_view::iterator::operator*}}
...
\rSec5[range.iota.iterator.inc]{\tcode{iota_view::iterator::operator++}}
...
\rSec5[range.iota.iterator.dec]{\tcode{iota_view::iterator::operator--}}
...
\rSec5[range.iota.iterator.adv]{\tcode{iota_view::iterator} advance}
...
\rSec5[range.iota.iterator.idx]{\tcode{iota_view::iterator} index}
...
\rSec4[range.iota.iterator.cmp]{\tcode{iota_view::iterator} comparisons}
...
\rSec4[range.iota.iterator.nonmember]{\tcode{iota_view::iterator} non-member functions}
...
\rSec4[range.iota.sentinel.ctor]{\tcode{iota_view::sentinel} constructors}
...
\rSec4[range.iota.sentinel.cmp]{\tcode{iota_view::sentinel} comparisons}
...
namespace std::ranges {
  ...
  private:
    ...
    iterator_t<R> current_ @\oldtxt{\{\}} \newtxt{= iterator_t<R>()}@;                  // \expos, only present if \tcode{!ForwardRange<R>}
...
namespace std::ranges {
  ...
  private:
    ...
    Parent* parent_ = nullptr;    // \expos
    iterator_t<Base> current_ @\oldtxt{\{\}} \newtxt{= iterator_t<Base>()}@; // \expos, present only if \tcode{R} models \libconcept{ForwardRange}
  public:
