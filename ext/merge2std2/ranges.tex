...
namespace std@\newtxt{::ranges}@ {
  ...
  template<InputRange R, CopyConstructible F>
    requires View<R> && is_object_v<F> && @\newtxt{Regular}@Invocable<F&, iter_reference_t<iterator_t<R>>>
...
namespace std::ranges {
  ...
  public:
    ...
    constexpr @\oldtxt{auto}\newtxt{iterator<true>}@ begin() const requires Range<const R> &&
      @\newtxt{Regular}@Invocable<const F&, iter_reference_t<iterator_t<const R>>>;

    constexpr @\oldtxt{auto}\newtxt{sentinel<false>}@ end();
    constexpr @\oldtxt{auto}\newtxt{iterator<false>}@ end() requires CommonRange<R>;
    constexpr @\oldtxt{auto}\newtxt{sentinel<true>}@ end() const requires Range<const R> &&
      @\newtxt{Regular}@Invocable<const F&, iter_reference_t<iterator_t<const R>>>;
    constexpr @\oldtxt{auto}\newtxt{iterator<true>}@ end() const requires CommonRange<const R> &&
      @\newtxt{Regular}@Invocable<const F&, iter_reference_t<iterator_t<const R>>>;

    constexpr auto size() requires SizedRange<R>@\oldtxt{;}@
    @\newtxt{\{ return ranges::size(base_); \}}@
    constexpr auto size() const requires SizedRange<const R>@\oldtxt{;}@
    @\newtxt{\{ return ranges::size(base_); \}}@
  };
