...
\oldtxt{and }\tcode{\oldtxt{return outer_sentinel<true>\{\oldtxt{*this}\};}}
\newtxt{where $C$ is \tcode{\placeholder{simple-view}<R>} or \tcode{true}}
for the first and second overloads, respectively.
\end{itemdescr}
...
namespace std@\newtxt{::ranges}@ { @\oldtxt{namespace ranges \{}@
  ...
  @\oldtxt{private:}@
    @\oldtxt{using Parent =                                       // \expos}@
      @\oldtxt{conditional_t<Const, const split_view, split_view>;}@
    @\oldtxt{using Base   = conditional_t<Const, const Rng, Rng>; // \expos}@
    @\oldtxt{sentinel_t<Base> end_;                               // \expos}@
  @\oldtxt{public:}@
    @\oldtxt{outer_sentinel() = default;}@
    @\oldtxt{constexpr explicit outer_sentinel(Parent\& parent);}@

    friend constexpr bool operator==(const outer_iterator<Const>& x, @\oldtxt{const}@ outer_sentinel@\oldtxt{\& y}@);
    friend constexpr bool operator==(@\oldtxt{const}@ outer_sentinel@\oldtxt{\& x}@, const outer_iterator<Const>& @\newtxt{x}\oldtxt{y}@);
    friend constexpr bool operator!=(const outer_iterator<Const>& x, @\oldtxt{const}@ outer_sentinel@\oldtxt{\&}@ y);
    friend constexpr bool operator!=(@\oldtxt{const}@ outer_sentinel@\oldtxt{\& x} \newtxt{y}@, const outer_iterator<Const>& @\newtxt{x}\oldtxt{y}@);
  };
}@\oldtxt{\}}@
\end{codeblock}
...
\begin{itemdecl}
friend constexpr bool operator==(const outer_iterator<Const>& x, @\oldtxt{const}@ outer_sentinel@\oldtxt{\& y}@);
@\newtxt{friend constexpr bool operator==(outer_sentinel, const outer_iterator<Const>\& x);}@
\end{itemdecl}
...
\effects Equivalent to:
\begin{codeblock}
return @\newtxt{x.}\placeholdernc{current}\oldtxt{(x)}@ == @\newtxt{ranges::end(x.parent_->base_)} \oldtxt{y.end_}@;
\end{codeblock}
...
\begin{itemdecl}
friend constexpr bool operator!=(const outer_iterator<Const>& x, @\oldtxt{const}@ outer_sentinel@\oldtxt{\&}@ y);
@\newtxt{friend constexpr bool operator!=(outer_sentinel y, const outer_iterator<Const>\& x);}@
\end{itemdecl}
