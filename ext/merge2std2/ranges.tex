...
\indexlibrary{\idxcode{begin}!\idxcode{split_view}}%
\begin{itemdecl}
constexpr auto begin() requires ForwardRange<V>;
constexpr auto begin() const
  requires ForwardRange<V> && ForwardRange<const V>;
\end{itemdecl}
...
namespace std::ranges {
  ...
  public:
    ...
    constexpr auto end()
      requires RandomAccessRange<V> && SizedRange<V>;
    constexpr auto end() const
      requires RandomAccessRange<const V> && SizedRange<V>;
  };
...
namespace std::ranges {
  ...
  public:
    ...
    constexpr auto begin();
    constexpr auto begin() requires CommonRange<V>;
...
\begin{itemdecl}
constexpr auto end() requires CommonRange<V>;
constexpr auto end() const requires CommonRange<const V>;
\end{itemdecl}
