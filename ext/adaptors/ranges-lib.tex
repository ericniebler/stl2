...
\ednote{Recommend changing the name of ``\tcode{BoundedRange}''~([ranges.bounded])
to ``\tcode{CommonRange}''~([ranges.common]):}

\begin{codeblock}
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  // ...

  // 10.6.5, \changed{BoundedRange}{CommonRange}
  template <class T>
  concept bool @\changed{BoundedRange}{CommonRange}@ = // as before
  ...
  template <WeaklyIncrementable I, Semiregular Bound = unreachable>
    requires WeaklyEqualityComparable@\added{With}@<I, Bound>
  class iota_view;
  ...
  @\added{// \ref{ranges.adaptors.common_view}:}@
  @\added{template <View Rng>}@
    @\added{requires !CommonRange<Rng>}@
  @\added{class common_view;}@

  @\added{namespace view \{ inline constexpr \unspec common = \unspec; \}}@
...
namespace std { namespace experimental { namespace ranges { inline namespace v1
{
  ...
  template <@\changed{BoundedRange}{CommonRange}@ R>
  ...
  public:
    ...
    constexpr decltype(auto) back()
      requires BidirectionalRange<D> && @\changed{BoundedRange}{CommonRange}@<D>;
    constexpr decltype(auto) back() const
      requires BidirectionalRange<const D> && @\changed{BoundedRange}{CommonRange}@<const D>;
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    constexpr iterator end() requires @\changed{BoundedRange}{CommonRange}@<R>;
  };
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    @\removed{using iterator = \xname{iterator}<false>;}@
    @\removed{using sentinel = \xname{sentinel}<false>;}@
    @\removed{using const_iterator = \xname{iterator}<true>;}@
    @\removed{using const_sentinel = \xname{sentinel}<true>;}@

    constexpr R base() const;

    constexpr @\changed{iterator}{auto}@ begin();
    constexpr @\changed{const_iterator}{auto}@ begin() const requires Range<const R> &&
      Invocable<const F&, reference_t<iterator_t<const R>>>;

    constexpr @\changed{sentinel}{auto}@ end();
    constexpr @\changed{const_sentinel}{auto}@ end() const requires Range<const R> &&
      Invocable<const F&, reference_t<iterator_t<const R>>>;
    constexpr @\changed{iterator}{auto}@ end() requires @\changed{BoundedRange}{CommonRange}@<R>;
    constexpr @\changed{const_iterator}{auto}@ end() const requires @\changed{BoundedRange}{CommonRange}@<const R> &&
      Invocable<const F&, reference_t<iterator_t<const R>>>;
...
\effects Equivalent to:
\begin{codeblock}
return @\added{\xname{iterator}<false>}@{*this, ranges::begin(base_)};
\end{codeblock}
\begin{addedblock}
  and
\begin{codeblock}
return @\added{\xname{iterator}<true>}@{*this, ranges::begin(base_)};
\end{codeblock}
...
\begin{itemdescr}
\pnum
\effects Equivalent to\added{:}
\begin{codeblock}
@\added{return} \changed{sentinel}{\xname{sentinel}<false>}\{ranges::end(base_)\}\added{;}@
\end{codeblock}
  and
\begin{codeblock}
@\added{return} \changed{const_sentinel}{\xname{sentinel}<true>}\{ranges::end(base_)\}\added{;}@
\end{codeblock}
for the first and second overload, respectively.
\end{itemdescr}
...
\begin{itemdecl}
constexpr @\changed{iterator}{auto}@ end() requires @\changed{BoundedRange}{CommonRange}@<R>;
constexpr @\changed{const_iterator}{auto}@ end() const requires @\changed{BoundedRange}{CommonRange}@<@\added{const}@ R> &&
  Invocable<const F&, reference_t<iterator_t<const R>>>;
\end{itemdecl}
...
\effects Equivalent to:
\begin{codeblock}
return @\added{\xname{iterator}<false>}@{*this, ranges::end(base_)};
\end{codeblock}
\begin{addedblock}
  and
\begin{codeblock}
return @\added{\xname{iterator}<true>}@{*this, ranges::end(base_)};
\end{codeblock}
for the first and second overload, respectively.
\end{addedblock}
\end{itemdescr}
...
for (int i : @\changed{squares}{indices}@)
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  @\removed{template <Incrementable I>}@
  @\removed{iota_view(I, I) -> iota_view<I, I>;}@

  template <WeaklyIncrementable I, Semiregular Bound>
    requires WeaklyEqualityComparable@\added{With}@<I, Bound> && @\removed{!ConvertibleTo<Bound, I>}@
      @\added{(!Integral<I> || !Integral<Bound> || is_signed_v<I> == is_signed_v<Bound>)}@
...
\begin{itemize}
\item \tcode{iota_view\{E, F\}} if \removed{either of} the following set\removed{s} of constraints
is satisfied:
\begin{itemize}
{\color{remclr}
...
WeaklyEqualityComparable@\added{With}@<I, J> && @\removed{!ConvertibleTo<J, I>}@
@\added{(!Integral<I> || !Integral<Bound> || std::is_signed_v<I> == std::is_signed_v<Bound>)}@
\end{codeblock}
\end{itemize}
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    @\removed{using iterator = iterator_t<take_view>;}@
    @\removed{using const_iterator = \seebelow;}@
    @\removed{using sentinel = sentinel_t<take_view>;}@
    @\removed{using const_sentinel = \seebelow;}@
  };
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    constexpr @\changed{const_iterator}{auto}@ begin() const requires InputRange<const R> &&
        is_reference_v<reference_t<iterator_t<const R>>>;

    constexpr @\changed{sentinel}{auto}@ end();

    constexpr @\changed{const_sentinel}{auto}@ end() const requires InputRange<const R> &&
        is_reference_v<reference_t<iterator_t<const R>>>;

    constexpr @\changed{iterator}{auto}@ end() requires ForwardRange<R> &&
        is_reference_v<InnerRng> && ForwardRange<InnerRng> &&
        @\changed{BoundedRange}{CommonRange}@<R> && @\changed{BoundedRange}{CommonRange}@<InnerRng>;

    constexpr @\changed{const_iterator}{auto}@ end() const requires ForwardRange<const R> &&
        is_reference_v<reference_t<iterator_t<const R>>> &&
        ForwardRange<reference_t<iterator_t<const R>>> &&
        @\changed{BoundedRange}{CommonRange}@<const R> && @\changed{BoundedRange}{CommonRange}@<reference_t<iterator_t<const R>>>;
  };
...
\begin{codeblock}
@\added{return \xname{iterator}<\textit{simple-view}<R{>}>}@{*this, ranges::begin(base_)}@\added{;}@
\end{codeblock}
\begin{addedblock}
and
\begin{codeblock}
...
\effects Equivalent to\added{:}
\begin{codeblock}
@\added{return} \changed{sentinel}{\xname{sentinel}<\textit{simple-view}<R>{>}}\{*this\}\added{;}@
\end{codeblock}
  and
\begin{codeblock}
@\added{return} \changed{const_sentinel}{\xname{sentinel}<true>}\{*this\}\added{;}@
\end{codeblock}
for the first and second overload, respectively.
\end{itemdescr}
...
\effects \added{Equivalent to:}
\begin{codeblock}
@\added{return \xname{iterator}<\textit{simple-view}<R{>}>}@{*this, ranges::end(base_)}@\added{;}@
\end{codeblock}
\begin{addedblock}
and
\begin{codeblock}
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    @\removed{using iterator = T*;}@
    @\removed{using const_iterator = T*;}@
    @\removed{using sentinel = T*;}@
    @\removed{using const_sentinel = T*;}@
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    @\removed{using iterator = const T*;}@
    @\removed{using const_iterator = const T*;}@
    @\removed{using sentinel = const T*;}@
    @\removed{using const_sentinel = const T*;}@
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    @\removed{using iterator = \xname{outer_iterator}<false>;}@
    @\removed{using sentinel = \xname{outer_sentinel}<false>;}@
    @\removed{using const_iterator = \xname{outer_iterator}<true>;}@
    @\removed{using const_sentinel = \xname{outer_sentinel}<true>;}@

    constexpr @\changed{iterator}{auto}@ begin();
    constexpr @\changed{iterator}{auto}@ begin() requires ForwardRange<Rng>;
    constexpr @\changed{const_iterator}{auto}@ begin() const requires ForwardRange<@\added{const}@ Rng>;

    constexpr @\changed{sentinel}{auto}@ end()
    constexpr @\changed{const_sentinel}{auto}@ end() const requires ForwardRange<@\added{const}@ Rng>;

    constexpr @\changed{iterator}{auto}@ end()
      requires ForwardRange<Rng> && @\changed{BoundedRange}{CommonRange}@<Rng>;
    constexpr @\changed{const_iterator}{auto}@ end() const
      requires ForwardRange<@\added{const}@ Rng> && @\changed{BoundedRange}{CommonRange}@<@\added{const}@ Rng>;
  };
...
\begin{itemdecl}
constexpr @\changed{iterator}{auto}@ begin() requires ForwardRange<Rng>;
constexpr @\changed{const_iterator}{auto}@ begin() const requires ForwardRange<Rng>;
\end{itemdecl}
...
\effects \added{Equivalent to:}
\begin{codeblock}
@\added{return \xname{outer_iterator}<\textit{simple-view}<R{>}>}@{*this, ranges::begin(base_)}@\added{;}@
\end{codeblock}
\begin{addedblock}
  and
\begin{codeblock}
...
\begin{itemdecl}
constexpr @\changed{sentinel}{auto}@ end()
constexpr @\changed{const_sentinel}{auto}@ end() const requires ForwardRange<Rng>;
\end{itemdecl}
...
\effects Equivalent to\added{:}
\begin{codeblock}
@\added{return} \changed{sentinel}{\xname{outer_sentinel}<\textit{simple-view}<R{>}>}@{*this}@\added{;}@
\end{codeblock}
and
\begin{codeblock}
@\added{return} \changed{const_sentinel}{\xname{outer_sentinel}<true>}@{*this}@\added{;}@
\end{codeblock}
for the first and second overloads, respectively.
\end{itemdescr}
...
\effects \added{Equivalent to:}
\begin{codeblock}
@\added{return \xname{outer_iterator}<\textit{simple-view}<R{>}>}@{*this, ranges::end(base_)}@\added{;}@
\end{codeblock}
\begin{addedblock}
  and
\begin{codeblock}
...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    @\removed{using iterator = \xname{inner_iterator}<Const>;}@
    @\removed{using sentinel = \xname{inner_sentinel}<Const>;}@
    @\removed{using const_iterator = \xname{inner_iterator}<Const>;}@
    @\removed{using const_sentinel = \xname{inner_sentinel}<Const>;}@

    constexpr @\changed{iterator}{auto}@ begin() const;
    constexpr @\changed{sentinel}{auto}@ end() const;
  };
}}}}
\end{codeblock}
...
\effects \added{Equivalent to:}
\begin{codeblock}
@\added{return} \changed{iterator}{\xname{inner_iterator}<Const>}\{i_\}\added{;}@
\end{codeblock}
\end{itemdescr}
...
\effects \added{Equivalent to:}
\begin{codeblock}
@\added{return} \changed{sentinel}{\xname{inner_sentinel}<Const>}\{\}\added{;}@
\end{codeblock}
\end{itemdescr}
...
\begin{itemize}
\item \tcode{\changed{iterator_range}{subrange}\{E, E + F\}} \changed{is}{if}
...
\begin{itemdecl}
template <ViewableRange O>
  requires @\changed{!CommonRange}{BidirectionalRange}@<O> && Constructible<Rng, all_view<O>>
explicit constexpr reverse_view(O&& o);
\end{itemdecl}
