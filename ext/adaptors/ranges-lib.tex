...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    constexpr auto size() requires SizedView<R>;
    constexpr auto size() const requires SizedView<const R>;
  };

  template <class R, class F>
    constexpr transform_view<all_view<R>, F> transform_view(R&& r, F fun) {
      return {view::all(std::forward<R>(r)), fun};
    }
}}}}
\end{codeblock}
...
\indexlibrary{\idxcode{transform_view::transform_view}}%
\begin{itemdecl}
constexpr transform_view(R base, F fun);
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::base}}%
\begin{itemdecl}
constexpr R base() const;
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::begin}}%
\begin{itemdecl}
constexpr iterator begin();
constexpr const_iterator begin() const
  requires View<const R> && Invocable<const F&, reference_t<iterator_t<const R>>>;
...
\indexlibrary{\idxcode{transform_view::end}}%
\begin{itemdecl}
constexpr sentinel end();
constexpr const_sentinel end() const
  requires View<const R> && Invocable<const F&, reference_t<iterator_t<const R>>>;
...
\indexlibrary{\idxcode{transform_view::size}}%
\begin{itemdecl}
constexpr auto size() requires SizedView<R>;
constexpr auto size() const requires SizedView<const R>;
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{iterator}::\xname{iterator}}}
\begin{itemdecl}
constexpr @\xname{iterator}@(Parent& parent, iterator_t<Base> current);
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{iterator}::base}}
\begin{itemdecl}
constexpr iterator_t<Base> base() const;
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{iterator}::operator*}}
\begin{itemdecl}
constexpr decltype(auto) operator*() const;
\end{itemdecl}
...
\rSec5[ranges.adaptors.transform_view.iterator.op.dec]{\tcode{transform_view::\xname{iterator}::operator--}}
...
\indexlibrary{\idxcode{transform_view::\xname{iterator}::iter_move}}
\begin{itemdecl}
friend constexpr decltype(auto) iter_move(const @\xname{iterator}@& i)
  noexcept(@\seebelow@);
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{iterator}::iter_swap}}
\begin{itemdecl}
friend constexpr void iter_swap(const @\xname{iterator}@& x, const @\xname{iterator}@& y)
  noexcept(@\seebelow@);
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{sentinel}::\xname{sentinel}}}
\begin{itemdecl}
explicit constexpr @\xname{sentinel}@(sentinel_t<Base> end);
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{sentinel}::base}}
\begin{itemdecl}
constexpr sentinel_t<Base> base() const;
\end{itemdecl}
...
\indexlibrary{\idxcode{transform_view::\xname{sentinel}::operator==}}
\begin{itemdecl}
friend constexpr bool operator==(const @\xname{iterator}@<Const>& x, const @\xname{sentinel}@& y);
\end{itemdecl}
