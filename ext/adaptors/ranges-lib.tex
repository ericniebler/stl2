...
28.3 [range.synopsis], add the following:}
...
\ednote{After subclause 28.6 [ranges.requirements], insert a new subclause
28.7, ``Range utilities'' with stable name [ranges.utilities]}
