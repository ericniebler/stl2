...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  public:
    ...
    constexpr @\changed{const_sentinel}{auto}@ end() const requires Range<const R> &&
      Invocable<const F&, reference_t<iterator_t<const R>>>;
    constexpr @\changed{iterator}{auto}@ end() requires BoundedRange<R>;
    constexpr @\changed{const_iterator}{auto}@ end() const requires BoundedRange<const R> &&
      Invocable<const F&, reference_t<iterator_t<const R>>>;
...
\begin{itemdecl}
constexpr @\changed{iterator}{auto}@ end() requires BoundedRange<R>;
constexpr @\changed{const_iterator}{auto}@ end() const requires BoundedRange<@\added{const}@ R> &&
  Invocable<const F&, reference_t<iterator_t<const R>>>;
\end{itemdecl}
