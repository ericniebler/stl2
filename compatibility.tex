...
\item Stricter type constraints for the algorithms (e.g., replacing \tcode{LessThanComparable} with
\tcode{TotallyOrdered}, \tcode{EqualityComparable} requires \tcode{op!=}.)
\item The standard function objects get constraints.
\item Iterators must be default constructible.
\item \tcode{iterator_traits} cannot be specialized.
\item Thing 1
\item Thing 2
\item Thing 3
\item All the Things!
